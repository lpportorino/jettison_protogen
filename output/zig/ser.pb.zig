...
pub const JonGuiDataDriveProgram = enum(i32) {
...
pub const JonGuiDataDriveState = enum(i32) {
...
pub const JonGuiDataSceneClass = enum(i32) {
...
pub const JonGuiDataHeatSceneClass = enum(i32) {
...
pub const JonGuiDataStabCorrection = struct {
    x_px: f32 = 0,
    y_px: f32 = 0,

    pub const _desc_table = .{
        .x_px = fd(1, .{ .scalar = .float }),
        .y_px = fd(2, .{ .scalar = .float }),
    };
...
pub const JonGuiDataDrive = struct {
    program: JonGuiDataDriveProgram = @enumFromInt(0),
    state: JonGuiDataDriveState = @enumFromInt(0),
    phase: i32 = 0,
    error_code: i32 = 0,
    poi_index: i32 = 0,
    park_in_progress: bool = false,
    tables_generation: u32 = 0,
    wasm_version: i32 = 0,
    ...
    pub const _desc_table = .{
        .program = fd(1, .@"enum"),
        .state = fd(2, .@"enum"),
        .phase = fd(3, .{ .scalar = .int32 }),
        .error_code = fd(4, .{ .scalar = .int32 }),
        .poi_index = fd(5, .{ .scalar = .int32 }),
        .park_in_progress = fd(6, .{ .scalar = .bool }),
        .tables_generation = fd(7, .{ .scalar = .uint32 }),
        .wasm_version = fd(8, .{ .scalar = .int32 }),
        .rejected_commands = fd(9, .{ .scalar = .uint32 }),
    };
...
pub const JonGuiDataScene = struct {
    day_auto: bool = false,
    day_class: JonGuiDataSceneClass = @enumFromInt(0),
    day_challenger: JonGuiDataSceneClass = @enumFromInt(0),
    day_hold_s: u32 = 0,
    day_hold_reason: []const u8 = &.{},
    day_mode: JonGuiDataFxModeDay = @enumFromInt(0),
    day_scores: std.ArrayListUnmanaged(f32) = .empty,
    heat_auto: bool = false,
    heat_class: JonGuiDataHeatSceneClass = @enumFromInt(0),
    heat_challenger: JonGuiDataHeatSceneClass = @enumFromInt(0),
    heat_hold_s: u32 = 0,
    heat_hold_reason: []const u8 = &.{},
    heat_mode: JonGuiDataFxModeHeat = @enumFromInt(0),
    heat_scores: std.ArrayListUnmanaged(f32) = .empty,
    shadow: bool = false,

    pub const _desc_table = .{
        .day_auto = fd(1, .{ .scalar = .bool }),
        .day_class = fd(2, .@"enum"),
        .day_challenger = fd(3, .@"enum"),
        .day_hold_s = fd(4, .{ .scalar = .uint32 }),
        .day_hold_reason = fd(5, .{ .scalar = .string }),
        .day_mode = fd(6, .@"enum"),
        .day_scores = fd(7, .{ .packed_repeated = .{ .scalar = .float }}),
        .heat_auto = fd(8, .{ .scalar = .bool }),
        .heat_class = fd(9, .@"enum"),
        .heat_challenger = fd(10, .@"enum"),
        .heat_hold_s = fd(11, .{ .scalar = .uint32 }),
        .heat_hold_reason = fd(12, .{ .scalar = .string }),
        .heat_mode = fd(13, .@"enum"),
        .heat_scores = fd(14, .{ .packed_repeated = .{ .scalar = .float }}),
        .shadow = fd(15, .{ .scalar = .bool }),
    };
...
pub const JonGUIState = struct {
    ...
    drive: ?JonGuiDataDrive = null,
    scene: ?JonGuiDataScene = null,
    ...
    pub const _desc_table = .{
        ...
        .drive = fd(30, .submessage),
        .scene = fd(31, .submessage),
    };
