...
#define NAMED_STYLE(field) {#field, &theme_inst.styles.field}
    NAMED_STYLE(panel),         NAMED_STYLE(control_rad),
    NAMED_STYLE(btn),           NAMED_STYLE(btn_shadow),
    NAMED_STYLE(item_rad),      NAMED_STYLE(btnm_pads),
    NAMED_STYLE(btnm_items),    NAMED_STYLE(accent_ink),
    NAMED_STYLE(roller_pad),    NAMED_STYLE(ta_pad),
    NAMED_STYLE(table_items),   NAMED_STYLE(table_grid),
    NAMED_STYLE(cb_ind),        NAMED_STYLE(cb_grow_off),
    NAMED_STYLE(led),           NAMED_STYLE(knob),
    NAMED_STYLE(scrollbar),     NAMED_STYLE(field_bg),
    NAMED_STYLE(focus),         NAMED_STYLE(checked_accent),
    NAMED_STYLE(roller_sel),    NAMED_STYLE(roller_sel_dis),
    NAMED_STYLE(edited_edge),   NAMED_STYLE(disabled),
    NAMED_STYLE(disabled_dim),  NAMED_STYLE(disabled_fill),
    NAMED_STYLE(disabled_edge), NAMED_STYLE(disabled_flat),
    NAMED_STYLE(hover),         NAMED_STYLE(pressed),
    NAMED_STYLE(track_tone),    NAMED_STYLE(readout_arc),
    NAMED_STYLE(knob_inert),    NAMED_STYLE(track_bg),
    NAMED_STYLE(tab_txt),       NAMED_STYLE(tab_bar_bg),
    NAMED_STYLE(tab_page_bg),   NAMED_STYLE(disabled_track),
    NAMED_STYLE(disabled_knob), NAMED_STYLE(cursor_off),
    NAMED_STYLE(trans),
#undef NAMED_STYLE
};
typedef enum {
