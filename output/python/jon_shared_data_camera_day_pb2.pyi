...
class JonGuiDataCameraDay(_message.Message):
    __slots__ = ("focus_pos", "zoom_pos", "iris_pos", "infrared_filter", "zoom_table_pos", "zoom_table_pos_max", "fx_mode", "auto_focus", "auto_iris", "auto_gain", "digital_zoom_level", "clahe_level", "horizontal_fov_degrees", "vertical_fov_degrees", "is_started", "meteo", "sensor_gain", "exposure", "capture_monotonic_us")
