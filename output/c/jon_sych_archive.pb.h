...
#define jon_archive_SychArchiveIndex_init_default {0, 0, {{NULL}, NULL}, {{NULL}, NULL}, false, jon_archive_TimelineIndex_init_default, false, jon_archive_OSDReference_init_default}
#define jon_archive_ArchiveEntry_init_default    {{{NULL}, NULL}, 0, 0, 0}
#define jon_archive_TimelineIndex_init_default   {0, 0, {{NULL}, NULL}}
#define jon_archive_VideoEntry_init_default      {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, false, jon_video_VideoMeta_init_default}
#define jon_archive_OSDReference_init_default    {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define jon_archive_SychArchiveIndex_init_zero   {0, 0, {{NULL}, NULL}, {{NULL}, NULL}, false, jon_archive_TimelineIndex_init_zero, false, jon_archive_OSDReference_init_zero}
#define jon_archive_ArchiveEntry_init_zero       {{{NULL}, NULL}, 0, 0, 0}
#define jon_archive_TimelineIndex_init_zero      {0, 0, {{NULL}, NULL}}
#define jon_archive_VideoEntry_init_zero         {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, false, jon_video_VideoMeta_init_zero}
#define jon_archive_OSDReference_init_zero       {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
