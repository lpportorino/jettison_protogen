...
class Root(_message.Message):
    __slots__ = ("start", "stop", "axis", "set_platform_azimuth", "set_platform_elevation", "set_platform_bank", "halt", "set_use_rotary_as_compass", "rotate_to_gps", "set_origin_gps", "set_mode", "rotate_to_ndc", "scan_start", "scan_stop", "scan_pause", "scan_unpause", "get_meteo", "scan_prev", "scan_next", "scan_refresh_node_list", "scan_select_node", "scan_delete_node", "scan_update_node", "scan_add_node", "halt_with_ndc", "set_spirit_level")
    ...
    SET_SPIRIT_LEVEL_FIELD_NUMBER: _ClassVar[int]
    start: Start
    stop: Stop
    axis: Axis
...
class SetSpiritLevel(_message.Message):
    __slots__ = ("pitch", "roll", "pan_offset", "tilt_offset")
    PITCH_FIELD_NUMBER: _ClassVar[int]
    ROLL_FIELD_NUMBER: _ClassVar[int]
    PAN_OFFSET_FIELD_NUMBER: _ClassVar[int]
    TILT_OFFSET_FIELD_NUMBER: _ClassVar[int]
    pitch: float
    roll: float
    pan_offset: float
    tilt_offset: float
    def __init__(self, pitch: _Optional[float] = ..., roll: _Optional[float] = ..., pan_offset: _Optional[float] = ..., tilt_offset: _Optional[float] = ...) -> None: ...
