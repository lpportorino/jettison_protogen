...
const file_jon_shared_data_camera_day_proto_rawDesc = "" +
	"\n" +
	" jon_shared_data_camera_day.proto\x12\x03ser\x1a\x1bjon_shared_data_types.proto\"\xa2\x03\n" +
	"\x13JonGuiDataCameraDay\x12\x1b\n" +
	"\tfocus_pos\x18\x01 \x01(\x02R\bfocusPos\x12\x19\n" +
	"\bzoom_pos\x18\x02 \x01(\x02R\azoomPos\x12\x19\n" +
	"\biris_pos\x18\x03 \x01(\x02R\airisPos\x12'\n" +
	"\x0finfrared_filter\x18\x04 \x01(\bR\x0einfraredFilter\x12$\n" +
	"\x0ezoom_table_pos\x18\x05 \x01(\x05R\fzoomTablePos\x12+\n" +
	"\x12zoom_table_pos_max\x18\x06 \x01(\x05R\x0fzoomTablePosMax\x121\n" +
	"\afx_mode\x18\a \x01(\x0e2\x18.ser.JonGuiDataFxModeDayR\x06fxMode\x12\x1d\n" +
	"\n" +
	...
	"claheLevelBRZPgit-codecommit.eu-central-1.amazonaws.com/v1/repos/jettison/jonp/data/camera_dayb\x06proto3"
