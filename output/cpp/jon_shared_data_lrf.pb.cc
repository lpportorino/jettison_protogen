...
inline constexpr JonGuiDataTarget::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        distance_c_{0},
        uuid_part4_{0},
        capture_type_{static_cast< ::ser::JonGuiDataTargetType >(0)} {}
...
const ::uint32_t
    TableStruct_jon_5fshared_5fdata_5flrf_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::ser::JonGuiDataTarget, _impl_.capture_type_),
        ~0u,
        ~0u,
        ~0u,
        ~0u,
...
void JonGuiDataLrf::clear_meteo() {
...
JonGuiDataLrf::JonGuiDataLrf(
  ...
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
           ...
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, measure_id_),
           offsetof(Impl_, scan_mode_) -
               offsetof(Impl_, measure_id_) +
               sizeof(Impl_::scan_mode_));
...
const ::_pbi::TcParseTable<4, 11, 2, 0, 2> JonGuiDataLrf::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastMtS1,
     {82, 1, 1, PROTOBUF_FIELD_OFFSET(JonGuiDataLrf, _impl_.meteo_)}},
    // int32 scan_mode = 11;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(JonGuiDataLrf, _impl_.scan_mode_), 63>(),
     {88, 63, 0, PROTOBUF_FIELD_OFFSET(JonGuiDataLrf, _impl_.scan_mode_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kBool)},
    // .ser.JonGuiDataMeteo meteo = 10;
    {PROTOBUF_FIELD_OFFSET(JonGuiDataLrf, _impl_.meteo_), _Internal::kHasBitsOffset + 1, 1,
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // int32 scan_mode = 11;
...
// @@protoc_insertion_point(message_clear_start:ser.JonGuiDataLrf)
  ...
  ::memset(&_impl_.measure_id_, 0, static_cast<::size_t>(
      reinterpret_cast<char*>(&_impl_.scan_mode_) -
      reinterpret_cast<char*>(&_impl_.measure_id_)) + sizeof(_impl_.scan_mode_));
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* JonGuiDataLrf::_InternalSerialize(
          ...
          if (cached_has_bits & 0x00000002u) {
            target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
                10, *this_._impl_.meteo_, this_._impl_.meteo_->GetCachedSize(), target,
                stream);
          }

          // int32 scan_mode = 11;
          if (this_._internal_scan_mode() != 0) {
            target = ::google::protobuf::internal::WireFormatLite::
...
void JonGuiDataLrf::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (from._internal_scan_mode() != 0) {
    _this->_impl_.scan_mode_ = from._impl_.scan_mode_;
  }
...
void JonGuiDataLrf::InternalSwap(JonGuiDataLrf* PROTOBUF_RESTRICT other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(JonGuiDataLrf, _impl_.scan_mode_)
      + sizeof(JonGuiDataLrf::_impl_.scan_mode_)
...
JonGuiDataTarget::JonGuiDataTarget(
  ...
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
           ...
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, timestamp_),
           offsetof(Impl_, capture_type_) -
               offsetof(Impl_, timestamp_) +
               sizeof(Impl_::capture_type_));
...
const ::_pbi::TcParseTable<5, 22, 1, 0, 2> JonGuiDataTarget::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastV32S2,
     {440, 63, 0, PROTOBUF_FIELD_OFFSET(JonGuiDataTarget, _impl_.capture_type_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kDouble)},
    // .ser.JonGuiDataTargetType capture_type = 23 [(.buf.validate.field) = {
    {PROTOBUF_FIELD_OFFSET(JonGuiDataTarget, _impl_.capture_type_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
  }}, {{
...
// @@protoc_insertion_point(message_clear_start:ser.JonGuiDataTarget)
  ...
  ::memset(&_impl_.timestamp_, 0, static_cast<::size_t>(
      ...
      reinterpret_cast<char*>(&_impl_.timestamp_)) + sizeof(_impl_.capture_type_));
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
        ...
        ::uint8_t* JonGuiDataTarget::_InternalSerialize(
          ...
          // .ser.JonGuiDataTargetType capture_type = 23 [(.buf.validate.field) = {
          if (this_._internal_capture_type() != 0) {
            target = stream->EnsureSpace(target);
            target = ::_pbi::WireFormatLite::WriteEnumToArray(
                23, this_._internal_capture_type(), target);
          }
        ...
        ::size_t JonGuiDataTarget::ByteSizeLong() const {
          ...
          ::_pbi::Prefetch5LinesFrom7Lines(&this_);
          ...
          }
           {
            ...
            if (this_._internal_capture_type() != 0) {
              total_size += 2 +
                            ::_pbi::WireFormatLite::EnumSize(this_._internal_capture_type());
            }
          }
          return this_.MaybeComputeUnknownFieldsSize(total_size,
                                                     &this_._impl_._cached_size_);
...
void JonGuiDataTarget::InternalSwap(JonGuiDataTarget* PROTOBUF_RESTRICT other) {
  ...
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(JonGuiDataTarget, _impl_.capture_type_)
      + sizeof(JonGuiDataTarget::_impl_.capture_type_)
