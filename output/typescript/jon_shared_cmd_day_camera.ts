...
export const Root: MessageFns<Root> = {
  encode(message: Root, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.sceneAuto !== undefined) {
      SceneAuto.encode(message.sceneAuto, writer.uint32(186).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Root {
    return {
      ...
      setIris: isSet(object.setIris)
        ? SetIris.fromJSON(object.setIris)
        : isSet(object.set_iris)
        ? SetIris.fromJSON(object.set_iris)
        : undefined,
      setInfraRedFilter: isSet(object.setInfraRedFilter)
        ? SetInfraRedFilter.fromJSON(object.setInfraRedFilter)
        : isSet(object.set_infra_red_filter)
        ? SetInfraRedFilter.fromJSON(object.set_infra_red_filter)
        : undefined,
      ...
      setAutoIris: isSet(object.setAutoIris)
        ? SetAutoIris.fromJSON(object.setAutoIris)
        : isSet(object.set_auto_iris)
        ? SetAutoIris.fromJSON(object.set_auto_iris)
        : undefined,
      haltAll: isSet(object.haltAll)
        ? HaltAll.fromJSON(object.haltAll)
        : isSet(object.halt_all)
        ? HaltAll.fromJSON(object.halt_all)
        : undefined,
      ...
      fxRoi: isSet(object.fxRoi)
        ...
        : undefined,
      setAutoGain: isSet(object.setAutoGain)
        ? SetAutoGain.fromJSON(object.setAutoGain)
        : isSet(object.set_auto_gain)
        ? SetAutoGain.fromJSON(object.set_auto_gain)
        : undefined,
  ...
  fromJSON(object: any): Focus {
    return {
      setValue: isSet(object.setValue)
        ? SetValue.fromJSON(object.setValue)
        : isSet(object.set_value)
        ? SetValue.fromJSON(object.set_value)
        : undefined,
      ...
      resetFocus: isSet(object.resetFocus)
        ? ResetFocus.fromJSON(object.resetFocus)
        : isSet(object.reset_focus)
        ? ResetFocus.fromJSON(object.reset_focus)
        : undefined,
      saveToTableFocus: isSet(object.saveToTableFocus)
        ? SaveToTableFocus.fromJSON(object.saveToTableFocus)
