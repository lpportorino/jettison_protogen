...
class JonGuiDataPMU(_message.Message):
    __slots__ = ("temperature", "is_started", "meteo", "voltage", "heater_power_state", "ina_voltage", "ina_current", "ina_power", "ina_power_fault")
    ...
    def __init__(self, temperature: _Optional[float] = ..., is_started: bool = ..., meteo: _Optional[_Union[_jon_shared_data_types_pb2.JonGuiDataMeteo, _Mapping]] = ..., voltage: _Optional[float] = ..., heater_power_state: bool = ..., ina_voltage: _Optional[float] = ..., ina_current: _Optional[float] = ..., ina_power: _Optional[float] = ..., ina_power_fault: bool = ...) -> None: ...
