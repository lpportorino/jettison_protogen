...
class JonGuiDataRotary(_message.Message):
    ...
    IS_PARKED_FIELD_NUMBER: _ClassVar[int]
    azimuth: float
    azimuth_speed: float
    elevation: float
