...
export const JonGuiDataTime: MessageFns<JonGuiDataTime> = {
  ...
  fromJSON(object: any): JonGuiDataTime {
    return {
      ...
      manualTimestamp: isSet(object.manualTimestamp)
        ? Long.fromValue(object.manualTimestamp)
        : isSet(object.manual_timestamp)
        ? Long.fromValue(object.manual_timestamp)
        : Long.ZERO,
      zoneId: isSet(object.zoneId)
        ...
        : 0,
      useManualTime: isSet(object.useManualTime)
        ? globalThis.Boolean(object.useManualTime)
        : isSet(object.use_manual_time)
        ? globalThis.Boolean(object.use_manual_time)
        : false,
    };
  },
