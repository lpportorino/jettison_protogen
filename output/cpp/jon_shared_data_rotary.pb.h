...
#ifndef GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5frotary_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5frotary_2eproto_2epb_2eh
...
class ScanNode final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ser.ScanNode) */ {
 public:
  inline ScanNode() : ScanNode(nullptr) {}
  ~ScanNode() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ScanNode(::google::protobuf::internal::ConstantInitialized);

  inline ScanNode(const ScanNode& from)
      : ScanNode(nullptr, from) {}
  ...
  ScanNode* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class JonGuiDataRotary final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ser.JonGuiDataRotary) */ {
 public:
  inline JonGuiDataRotary() : JonGuiDataRotary(nullptr) {}
  ~JonGuiDataRotary() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR JonGuiDataRotary(::google::protobuf::internal::ConstantInitialized);

  inline JonGuiDataRotary(const JonGuiDataRotary& from)
      : JonGuiDataRotary(nullptr, from) {}
  JonGuiDataRotary(JonGuiDataRotary&& from) noexcept
    : JonGuiDataRotary() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(JonGuiDataRotary& a, JonGuiDataRotary& b) {
    a.Swap(&b);
  }
  ...
  JonGuiDataRotary* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<JonGuiDataRotary>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const JonGuiDataRotary& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const JonGuiDataRotary& from) {
    JonGuiDataRotary::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
...
inline ::ser::ScanNode* JonGuiDataRotary::_internal_mutable_current_scan_node() {
  ...
  if (_impl_.current_scan_node_ == nullptr) {
    auto* p = CreateMaybeMessage<::ser::ScanNode>(GetArena());
...
inline void JonGuiDataRotary::set_allocated_current_scan_node(::ser::ScanNode* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::ser::ScanNode*>(_impl_.current_scan_node_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::ser::ScanNode*>(value)->GetArena();
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5frotary_2eproto_2epb_2eh
