...
func (m *Root) validate(all bool) error {
	...
	case *Root_SetManualPosition:
		...
		if all {
			switch v := interface{}(m.GetSetManualPosition()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, RootValidationError{
						field:  "SetManualPosition",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetSetManualPosition()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return RootValidationError{
					field:  "SetManualPosition",
					reason: "embedded message failed validation",
	...
	case *Root_SetUseManualPosition:
		if v == nil {
			err := RootValidationError{
				field:  "Cmd",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetSetUseManualPosition()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, RootValidationError{
						field:  "SetUseManualPosition",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetSetUseManualPosition()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return RootValidationError{
					field:  "SetUseManualPosition",
					reason: "embedded message failed validation",
...
// Validate checks the field values on SetUseManualPosition with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SetUseManualPosition) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SetUseManualPosition with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SetUseManualPositionMultiError, or nil if none found.
func (m *SetUseManualPosition) ValidateAll() error {
	return m.validate(true)
}

func (m *SetUseManualPosition) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SetUseManualPositionMultiError(errors)
	}

	return nil
}

// SetUseManualPositionMultiError is an error wrapping multiple validation
// errors returned by SetUseManualPosition.ValidateAll() if the designated
// constraints aren't met.
type SetUseManualPositionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SetUseManualPositionMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SetUseManualPositionMultiError) AllErrors() []error { return m }

// SetUseManualPositionValidationError is the validation error returned by
// SetUseManualPosition.Validate if the designated constraints aren't met.
type SetUseManualPositionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SetUseManualPositionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SetUseManualPositionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SetUseManualPositionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SetUseManualPositionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SetUseManualPositionValidationError) ErrorName() string {
	return "SetUseManualPositionValidationError"
}

// Error satisfies the builtin error interface
func (e SetUseManualPositionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSetUseManualPosition.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SetUseManualPositionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SetUseManualPositionValidationError{}

// Validate checks the field values on SetManualPosition with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *SetManualPosition) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SetManualPosition with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SetManualPositionMultiError, or nil if none found.
func (m *SetManualPosition) ValidateAll() error {
	return m.validate(true)
}

func (m *SetManualPosition) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SetManualPositionMultiError(errors)
	}

	return nil
}

// SetManualPositionMultiError is an error wrapping multiple validation errors
// returned by SetManualPosition.ValidateAll() if the designated constraints
// aren't met.
type SetManualPositionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SetManualPositionMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SetManualPositionMultiError) AllErrors() []error { return m }

// SetManualPositionValidationError is the validation error returned by
// SetManualPosition.Validate if the designated constraints aren't met.
type SetManualPositionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SetManualPositionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SetManualPositionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SetManualPositionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SetManualPositionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SetManualPositionValidationError) ErrorName() string {
	return "SetManualPositionValidationError"
}

// Error satisfies the builtin error interface
func (e SetManualPositionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSetManualPosition.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SetManualPositionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SetManualPositionValidationError{}
