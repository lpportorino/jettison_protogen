  ...
  fromJSON(object: any): VideoMeta {
    return {
      ...
      durationMs: isSet(object.durationMs)
        ...
        : 0,
      sampleTable: isSet(object.sampleTable)
        ? SampleTable.fromJSON(object.sampleTable)
        : isSet(object.sample_table)
        ? SampleTable.fromJSON(object.sample_table)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): SampleTable {
    return {
      sampleSizes: globalThis.Array.isArray(object?.sampleSizes)
        ...
        : globalThis.Array.isArray(object?.sample_sizes)
        ? object.sample_sizes.map((e: any) => globalThis.Number(e))
        : [],
      chunkOffsets: globalThis.Array.isArray(object?.chunkOffsets)
        ? object.chunkOffsets.map((e: any) => Long.fromValue(e))
        : globalThis.Array.isArray(object?.chunk_offsets)
        ? object.chunk_offsets.map((e: any) => Long.fromValue(e))
        : [],
      sampleTimes: globalThis.Array.isArray(object?.sampleTimes)
        ? object.sampleTimes.map((e: any) => globalThis.Number(e))
        : globalThis.Array.isArray(object?.sample_times)
        ? object.sample_times.map((e: any) => globalThis.Number(e))
        : [],
      syncSamples: globalThis.Array.isArray(object?.syncSamples)
        ? object.syncSamples.map((e: any) => globalThis.Number(e))
        : globalThis.Array.isArray(object?.sync_samples)
        ? object.sync_samples.map((e: any) => globalThis.Number(e))
        : [],
      sampleToChunk: globalThis.Array.isArray(object?.sampleToChunk)
        ? object.sampleToChunk.map((e: any) => SampleToChunk.fromJSON(e))
        : globalThis.Array.isArray(object?.sample_to_chunk)
        ? object.sample_to_chunk.map((e: any) => SampleToChunk.fromJSON(e))
        : [],
    };
  },
...
export const SampleToChunk: MessageFns<SampleToChunk> = {
  ...
  fromJSON(object: any): SampleToChunk {
    return {
      firstChunk: isSet(object.firstChunk)
        ? globalThis.Number(object.firstChunk)
        : isSet(object.first_chunk)
        ? globalThis.Number(object.first_chunk)
        : 0,
      samplesPerChunk: isSet(object.samplesPerChunk)
        ? globalThis.Number(object.samplesPerChunk)
        : isSet(object.samples_per_chunk)
        ? globalThis.Number(object.samples_per_chunk)
        : 0,
      sampleDescriptionIndex: isSet(object.sampleDescriptionIndex)
        ? globalThis.Number(object.sampleDescriptionIndex)
        : isSet(object.sample_description_index)
        ? globalThis.Number(object.sample_description_index)
        : 0,
    };
  },
  ...
  fromJSON(object: any): VideoError {
    return {
      ...
      errorType: isSet(object.errorType)
        ? videoErrorTypeFromJSON(object.errorType)
        : isSet(object.error_type)
        ? videoErrorTypeFromJSON(object.error_type)
        : 0,
