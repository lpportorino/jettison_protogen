...
import { JonGuiDataScene } from "./jon_shared_data_scene";
...
export const JonGUIState: MessageFns<JonGUIState> = {
  encode(message: JonGUIState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.scene !== undefined) {
      JonGuiDataScene.encode(message.scene, writer.uint32(250).fork()).join();
    }
    return writer;
  },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 31: {
            ...
            message.scene = JonGuiDataScene.decode(reader, reader.uint32());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): JonGUIState {
    return {
      ...
      systemMonotonicTimeUs: isSet(object.systemMonotonicTimeUs)
        ...
        : isSet(object.system_monotonic_time_us)
        ? Long.fromValue(object.system_monotonic_time_us)
        : Long.UZERO,
      stateSource: isSet(object.stateSource)
        ? jonGuiDataStateSourceFromJSON(object.stateSource)
        : isSet(object.state_source)
        ? jonGuiDataStateSourceFromJSON(object.state_source)
        : 0,
      framePtsDayNs: isSet(object.framePtsDayNs)
        ? Long.fromValue(object.framePtsDayNs)
        : isSet(object.frame_pts_day_ns)
        ? Long.fromValue(object.frame_pts_day_ns)
        : Long.UZERO,
      framePtsHeatNs: isSet(object.framePtsHeatNs)
        ? Long.fromValue(object.framePtsHeatNs)
        : isSet(object.frame_pts_heat_ns)
        ? Long.fromValue(object.frame_pts_heat_ns)
        : Long.UZERO,
      frameMonotonicDayUs: isSet(object.frameMonotonicDayUs)
        ? Long.fromValue(object.frameMonotonicDayUs)
        : isSet(object.frame_monotonic_day_us)
        ? Long.fromValue(object.frame_monotonic_day_us)
        : Long.UZERO,
      frameMonotonicHeatUs: isSet(object.frameMonotonicHeatUs)
        ? Long.fromValue(object.frameMonotonicHeatUs)
        : isSet(object.frame_monotonic_heat_us)
        ? Long.fromValue(object.frame_monotonic_heat_us)
        : Long.UZERO,
      ...
      meteoInternal: isSet(object.meteoInternal)
        ? JonGuiDataMeteo.fromJSON(object.meteoInternal)
        : isSet(object.meteo_internal)
        ? JonGuiDataMeteo.fromJSON(object.meteo_internal)
        : undefined,
      ...
      compassCalibration: isSet(object.compassCalibration)
        ...
        : isSet(object.compass_calibration)
        ? JonGuiDataCompassCalibration.fromJSON(object.compass_calibration)
        : undefined,
      recOsd: isSet(object.recOsd)
        ? JonGuiDataRecOsd.fromJSON(object.recOsd)
      ...
      actualSpaceTime: isSet(object.actualSpaceTime)
        ...
        ? JonGuiDataActualSpaceTime.fromJSON(object.actual_space_time)
        : undefined,
      ...
      scene: isSet(object.scene) ? JonGuiDataScene.fromJSON(object.scene) : undefined,
    };
  },
  ...
  toJSON(message: JonGUIState): unknown {
    ...
    if (message.scene !== undefined) {
      obj.scene = JonGuiDataScene.toJSON(message.scene);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<JonGUIState>, I>>(object: I): JonGUIState {
    ...
    message.scene = (object.scene !== undefined && object.scene !== null)
      ? JonGuiDataScene.fromPartial(object.scene)
      : undefined;
    return message;
  },
};
