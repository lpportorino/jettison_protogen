...
class Root(_message.Message):
    __slots__ = ("protocol_version", "session_id", "important", "from_cv_subsystem", "client_type", "client_app", "frame_time_day", "frame_time_heat", "state_time", "client_time_ms", "opaque_payloads", "day_camera", "heat_camera", "gps", "compass", "lrf", "lrf_calib", "rotary", "osd", "ping", "noop", "frozen", "system", "cv", "lira", "power", "pmu", "heater")
