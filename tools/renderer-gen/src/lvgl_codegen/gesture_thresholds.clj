(ns lvgl-codegen.gesture-thresholds
  "The one home for the native gesture recognizer's tuning constants.
   ...
   The C projection must agree with the EDN home, and
   `lvgl-codegen.gesture-thresholds-test` is the drift canary:
     • generated/gesture_thresholds.h — C #defines (emitted here, the lvgl
       T11 host recognizer includes it)
...
(defn generate-header!
  "Write the generated C header (`generated/gesture_thresholds.h`) from the EDN
   home. Run via `make factory-bindings`; the mirror gate pins the committed
   header against the live home."
  [home-path out-path]
