...
export const Root: MessageFns<Root> = {
  ...
  fromJSON(object: any): Root {
    return {
      startAll: isSet(object.startAll)
        ? StartALl.fromJSON(object.startAll)
        : isSet(object.start_all)
        ? StartALl.fromJSON(object.start_all)
        : undefined,
      stopAll: isSet(object.stopAll)
        ? StopALl.fromJSON(object.stopAll)
        : isSet(object.stop_all)
        ? StopALl.fromJSON(object.stop_all)
        : undefined,
      ...
      resetConfigs: isSet(object.resetConfigs)
        ? ResetConfigs.fromJSON(object.resetConfigs)
        : isSet(object.reset_configs)
        ? ResetConfigs.fromJSON(object.reset_configs)
        : undefined,
      startRec: isSet(object.startRec)
        ? StartRec.fromJSON(object.startRec)
        : isSet(object.start_rec)
        ? StartRec.fromJSON(object.start_rec)
        : undefined,
      stopRec: isSet(object.stopRec)
        ? StopRec.fromJSON(object.stopRec)
        : isSet(object.stop_rec)
        ? StopRec.fromJSON(object.stop_rec)
        : undefined,
      markRecImportant: isSet(object.markRecImportant)
        ? MarkRecImportant.fromJSON(object.markRecImportant)
        : isSet(object.mark_rec_important)
        ? MarkRecImportant.fromJSON(object.mark_rec_important)
        : undefined,
      unmarkRecImportant: isSet(object.unmarkRecImportant)
        ? UnmarkRecImportant.fromJSON(object.unmarkRecImportant)
        : isSet(object.unmark_rec_important)
        ? UnmarkRecImportant.fromJSON(object.unmark_rec_important)
        : undefined,
      enterTransport: isSet(object.enterTransport)
        ? EnterTransport.fromJSON(object.enterTransport)
        : isSet(object.enter_transport)
        ? EnterTransport.fromJSON(object.enter_transport)
        : undefined,
      geodesicModeEnable: isSet(object.geodesicModeEnable)
        ? EnableGeodesicMode.fromJSON(object.geodesicModeEnable)
        : isSet(object.geodesic_mode_enable)
        ? EnableGeodesicMode.fromJSON(object.geodesic_mode_enable)
        : undefined,
      geodesicModeDisable: isSet(object.geodesicModeDisable)
        ? DisableGeodesicMode.fromJSON(object.geodesicModeDisable)
        : isSet(object.geodesic_mode_disable)
        ? DisableGeodesicMode.fromJSON(object.geodesic_mode_disable)
        : undefined,
      saveFactoryDefaults: isSet(object.saveFactoryDefaults)
        ? SaveFactoryDefaults.fromJSON(object.saveFactoryDefaults)
        : isSet(object.save_factory_defaults)
        ? SaveFactoryDefaults.fromJSON(object.save_factory_defaults)
        : undefined,
      wipeUserData: isSet(object.wipeUserData)
        ? WipeUserData.fromJSON(object.wipeUserData)
        : isSet(object.wipe_user_data)
        ? WipeUserData.fromJSON(object.wipe_user_data)
        : undefined,
      stepYear: isSet(object.stepYear)
        ? StepYear.fromJSON(object.stepYear)
        : isSet(object.step_year)
        ? StepYear.fromJSON(object.step_year)
        : undefined,
      stepMonth: isSet(object.stepMonth)
        ? StepMonth.fromJSON(object.stepMonth)
        : isSet(object.step_month)
        ? StepMonth.fromJSON(object.step_month)
        : undefined,
      stepDay: isSet(object.stepDay)
        ? StepDay.fromJSON(object.stepDay)
        : isSet(object.step_day)
        ? StepDay.fromJSON(object.step_day)
        : undefined,
      stepHour: isSet(object.stepHour)
        ? StepHour.fromJSON(object.stepHour)
        : isSet(object.step_hour)
        ? StepHour.fromJSON(object.step_hour)
        : undefined,
      stepMinute: isSet(object.stepMinute)
        ? StepMinute.fromJSON(object.stepMinute)
        : isSet(object.step_minute)
        ? StepMinute.fromJSON(object.step_minute)
        : undefined,
      stepSecond: isSet(object.stepSecond)
        ? StepSecond.fromJSON(object.stepSecond)
        : isSet(object.step_second)
        ? StepSecond.fromJSON(object.step_second)
        : undefined,
      enableManualTime: isSet(object.enableManualTime)
        ? EnableManualTime.fromJSON(object.enableManualTime)
        : isSet(object.enable_manual_time)
        ? EnableManualTime.fromJSON(object.enable_manual_time)
        : undefined,
      disableManualTime: isSet(object.disableManualTime)
        ? DisableManualTime.fromJSON(object.disableManualTime)
        : isSet(object.disable_manual_time)
        ? DisableManualTime.fromJSON(object.disable_manual_time)
        : undefined,
      setTimeZone: isSet(object.setTimeZone)
        ? SetTimeZone.fromJSON(object.setTimeZone)
        : isSet(object.set_time_zone)
        ? SetTimeZone.fromJSON(object.set_time_zone)
        : undefined,
      stepTimeZone: isSet(object.stepTimeZone)
        ? StepTimeZone.fromJSON(object.stepTimeZone)
        : isSet(object.step_time_zone)
        ? StepTimeZone.fromJSON(object.step_time_zone)
        : undefined,
      setTimeAndZone: isSet(object.setTimeAndZone)
        ? SetTimeAndZone.fromJSON(object.setTimeAndZone)
        : isSet(object.set_time_and_zone)
        ? SetTimeAndZone.fromJSON(object.set_time_and_zone)
        : undefined,
    };
  },
