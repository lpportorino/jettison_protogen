...
@kotlin.jvm.JvmName("-initializeobjectDetectionsHeat")
public inline fun objectDetectionsHeat(block: ser.ObjectDetectionsHeatKt.Dsl.() -> kotlin.Unit): ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeat =
  ser.ObjectDetectionsHeatKt.Dsl._create(ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeat.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `ser.ObjectDetectionsHeat`
 */
public object ObjectDetectionsHeatKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeat.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeat.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeat = _builder.build()
    ...
    public val ObjectDetectionsHeatKt.Dsl.frameOrNull: ser.DetectionCommon.DetectionFrameMeta?
    ...
    public val ObjectDetectionsHeatKt.Dsl.configOrNull: ser.DetectionCommon.DetectionConfig?
...
@kotlin.jvm.JvmSynthetic
public inline fun ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeat.copy(block: `ser`.ObjectDetectionsHeatKt.Dsl.() -> kotlin.Unit): ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeat =
  `ser`.ObjectDetectionsHeatKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeatOrBuilder.frameOrNull: ser.DetectionCommon.DetectionFrameMeta?
  get() = if (hasFrame()) getFrame() else null

public val ser.ObjectDetectionsHeatOuterClass.ObjectDetectionsHeatOrBuilder.configOrNull: ser.DetectionCommon.DetectionConfig?
