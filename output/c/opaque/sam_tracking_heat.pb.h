...
#ifndef PB_SER_OPAQUE_SAM_TRACKING_HEAT_PB_H_INCLUDED
#define PB_SER_OPAQUE_SAM_TRACKING_HEAT_PB_H_INCLUDED
#include <pb.h>
...
typedef struct _ser_SamTrackingHeat {
...
#define ser_SamTrackingHeat_init_default         {_ser_SamTrackingStatus_MIN, _ser_SamTrackingState_MIN, 0, 0, 0, 0, 0, 0, 0, 0, {{NULL}, NULL}, 0, 0, 0, false, ser_SamTrackingFrameMeta_init_default, false, ser_SamTrackingKalmanState_init_default, 0, 0}
#define ser_SamTrackingHeat_init_zero            {_ser_SamTrackingStatus_MIN, _ser_SamTrackingState_MIN, 0, 0, 0, 0, 0, 0, 0, 0, {{NULL}, NULL}, 0, 0, 0, false, ser_SamTrackingFrameMeta_init_zero, false, ser_SamTrackingKalmanState_init_zero, 0, 0}

/* Field tags (for use in manual encoding/decoding) */
#define ser_SamTrackingHeat_status_tag           1
#define ser_SamTrackingHeat_state_tag            2
#define ser_SamTrackingHeat_bbox_x1_tag          3
#define ser_SamTrackingHeat_bbox_y1_tag          4
#define ser_SamTrackingHeat_bbox_x2_tag          5
#define ser_SamTrackingHeat_bbox_y2_tag          6
#define ser_SamTrackingHeat_centroid_x_tag       7
#define ser_SamTrackingHeat_centroid_y_tag       8
#define ser_SamTrackingHeat_confidence_tag       9
#define ser_SamTrackingHeat_iou_tag              10
#define ser_SamTrackingHeat_mask_rle_tag         11
#define ser_SamTrackingHeat_mask_width_tag       12
#define ser_SamTrackingHeat_mask_height_tag      13
#define ser_SamTrackingHeat_mask_pixels_tag      14
#define ser_SamTrackingHeat_frame_tag            15
#define ser_SamTrackingHeat_kalman_tag           16
#define ser_SamTrackingHeat_lost_frame_count_tag 17
#define ser_SamTrackingHeat_latency_ns_tag       18

/* Struct field encoding specification for nanopb */
#define ser_SamTrackingHeat_FIELDLIST(X, a) \
...
#define ser_SamTrackingHeat_CALLBACK pb_default_field_callback
#define ser_SamTrackingHeat_DEFAULT NULL
#define ser_SamTrackingHeat_frame_MSGTYPE ser_SamTrackingFrameMeta
#define ser_SamTrackingHeat_kalman_MSGTYPE ser_SamTrackingKalmanState

extern const pb_msgdesc_t ser_SamTrackingHeat_msg;

/* Defines for backwards compatibility with code written before nanopb-0.4.0 */
#define ser_SamTrackingHeat_fields &ser_SamTrackingHeat_msg

/* Maximum encoded size of messages (where known) */
/* ser_SamTrackingHeat_size depends on runtime parameters */
