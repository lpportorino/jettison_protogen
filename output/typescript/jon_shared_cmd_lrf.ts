...
export const Root: MessageFns<Root> = {
  ...
  fromJSON(object: any): Root {
    return {
      ...
      scanOn: isSet(object.scanOn)
        ? ScanOn.fromJSON(object.scanOn)
        : isSet(object.scan_on)
        ? ScanOn.fromJSON(object.scan_on)
        : undefined,
      scanOff: isSet(object.scanOff)
        ? ScanOff.fromJSON(object.scanOff)
        : isSet(object.scan_off)
        ? ScanOff.fromJSON(object.scan_off)
        : undefined,
      ...
      targetDesignatorOff: isSet(object.targetDesignatorOff)
        ...
        : isSet(object.target_designator_off)
        ? TargetDesignatorOff.fromJSON(object.target_designator_off)
        : undefined,
      targetDesignatorOnModeA: isSet(object.targetDesignatorOnModeA)
        ...
        : isSet(object.target_designator_on_mode_a)
        ? TargetDesignatorOnModeA.fromJSON(object.target_designator_on_mode_a)
        : undefined,
      targetDesignatorOnModeB: isSet(object.targetDesignatorOnModeB)
        ...
        : isSet(object.target_designator_on_mode_b)
        ? TargetDesignatorOnModeB.fromJSON(object.target_designator_on_mode_b)
        : undefined,
      enableFogMode: isSet(object.enableFogMode)
        ? EnableFogMode.fromJSON(object.enableFogMode)
        : isSet(object.enable_fog_mode)
        ? EnableFogMode.fromJSON(object.enable_fog_mode)
        : undefined,
      disableFogMode: isSet(object.disableFogMode)
        ? DisableFogMode.fromJSON(object.disableFogMode)
        : isSet(object.disable_fog_mode)
        ? DisableFogMode.fromJSON(object.disable_fog_mode)
        : undefined,
      setScanMode: isSet(object.setScanMode)
        ? SetScanMode.fromJSON(object.setScanMode)
        : isSet(object.set_scan_mode)
        ? SetScanMode.fromJSON(object.set_scan_mode)
        : undefined,
      ...
      getMeteo: isSet(object.getMeteo)
        ...
        : undefined,
      refineOn: isSet(object.refineOn)
        ? RefineOn.fromJSON(object.refineOn)
        : isSet(object.refine_on)
        ? RefineOn.fromJSON(object.refine_on)
        : undefined,
      refineOff: isSet(object.refineOff)
        ? RefineOff.fromJSON(object.refineOff)
        : isSet(object.refine_off)
        ? RefineOff.fromJSON(object.refine_off)
        : undefined,
    };
  },
