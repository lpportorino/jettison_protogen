...
export const JonGuiDataSystem: MessageFns<JonGuiDataSystem> = {
  encode(message: JonGuiDataSystem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.totalOperatingHours.equals(Long.ZERO)) {
      writer.uint32(216).int64(message.totalOperatingHours.toString());
    }
    return writer;
  },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 27: {
            ...
            message.totalOperatingHours = Long.fromString(reader.int64().toString());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): JonGuiDataSystem {
    return {
      cpuTemperature: isSet(object.cpuTemperature)
        ? globalThis.Number(object.cpuTemperature)
        : isSet(object.cpu_temperature)
        ? globalThis.Number(object.cpu_temperature)
        : 0,
      gpuTemperature: isSet(object.gpuTemperature)
        ? globalThis.Number(object.gpuTemperature)
        : isSet(object.gpu_temperature)
        ? globalThis.Number(object.gpu_temperature)
        : 0,
      gpuLoad: isSet(object.gpuLoad)
        ? globalThis.Number(object.gpuLoad)
        : isSet(object.gpu_load)
        ? globalThis.Number(object.gpu_load)
        : 0,
      cpuLoad: isSet(object.cpuLoad)
        ? globalThis.Number(object.cpuLoad)
        : isSet(object.cpu_load)
        ? globalThis.Number(object.cpu_load)
        : 0,
      powerConsumption: isSet(object.powerConsumption)
        ? globalThis.Number(object.powerConsumption)
        : isSet(object.power_consumption)
        ? globalThis.Number(object.power_consumption)
        : 0,
      loc: isSet(object.loc) ? jonGuiDataSystemLocalizationsFromJSON(object.loc) : 0,
      curVideoRecDirYear: isSet(object.curVideoRecDirYear)
        ? globalThis.Number(object.curVideoRecDirYear)
        : isSet(object.cur_video_rec_dir_year)
        ? globalThis.Number(object.cur_video_rec_dir_year)
        : 0,
      curVideoRecDirMonth: isSet(object.curVideoRecDirMonth)
        ? globalThis.Number(object.curVideoRecDirMonth)
        : isSet(object.cur_video_rec_dir_month)
        ? globalThis.Number(object.cur_video_rec_dir_month)
        : 0,
      curVideoRecDirDay: isSet(object.curVideoRecDirDay)
        ? globalThis.Number(object.curVideoRecDirDay)
        : isSet(object.cur_video_rec_dir_day)
        ? globalThis.Number(object.cur_video_rec_dir_day)
        : 0,
      curVideoRecDirHour: isSet(object.curVideoRecDirHour)
        ? globalThis.Number(object.curVideoRecDirHour)
        : isSet(object.cur_video_rec_dir_hour)
        ? globalThis.Number(object.cur_video_rec_dir_hour)
        : 0,
      curVideoRecDirMinute: isSet(object.curVideoRecDirMinute)
        ? globalThis.Number(object.curVideoRecDirMinute)
        : isSet(object.cur_video_rec_dir_minute)
        ? globalThis.Number(object.cur_video_rec_dir_minute)
        : 0,
      curVideoRecDirSecond: isSet(object.curVideoRecDirSecond)
        ? globalThis.Number(object.curVideoRecDirSecond)
        : isSet(object.cur_video_rec_dir_second)
        ? globalThis.Number(object.cur_video_rec_dir_second)
        : 0,
      recEnabled: isSet(object.recEnabled)
        ? globalThis.Boolean(object.recEnabled)
        : isSet(object.rec_enabled)
        ? globalThis.Boolean(object.rec_enabled)
        : false,
      importantRecEnabled: isSet(object.importantRecEnabled)
        ? globalThis.Boolean(object.importantRecEnabled)
        : isSet(object.important_rec_enabled)
        ? globalThis.Boolean(object.important_rec_enabled)
        : false,
      lowDiskSpace: isSet(object.lowDiskSpace)
        ? globalThis.Boolean(object.lowDiskSpace)
        : isSet(object.low_disk_space)
        ? globalThis.Boolean(object.low_disk_space)
        : false,
      noDiskSpace: isSet(object.noDiskSpace)
        ? globalThis.Boolean(object.noDiskSpace)
        : isSet(object.no_disk_space)
        ? globalThis.Boolean(object.no_disk_space)
        : false,
      diskSpace: isSet(object.diskSpace)
        ? globalThis.Number(object.diskSpace)
        : isSet(object.disk_space)
        ? globalThis.Number(object.disk_space)
        : 0,
      tracking: isSet(object.tracking) ? globalThis.Boolean(object.tracking) : false,
      vampireMode: isSet(object.vampireMode)
        ? globalThis.Boolean(object.vampireMode)
        : isSet(object.vampire_mode)
        ? globalThis.Boolean(object.vampire_mode)
        : false,
      stabilizationMode: isSet(object.stabilizationMode)
        ? globalThis.Boolean(object.stabilizationMode)
        : isSet(object.stabilization_mode)
        ? globalThis.Boolean(object.stabilization_mode)
        : false,
      geodesicMode: isSet(object.geodesicMode)
        ? globalThis.Boolean(object.geodesicMode)
        : isSet(object.geodesic_mode)
        ? globalThis.Boolean(object.geodesic_mode)
        : false,
      cvDumping: isSet(object.cvDumping)
        ? globalThis.Boolean(object.cvDumping)
        : isSet(object.cv_dumping)
        ? globalThis.Boolean(object.cv_dumping)
        : false,
      recognitionMode: isSet(object.recognitionMode)
        ? globalThis.Boolean(object.recognitionMode)
        : isSet(object.recognition_mode)
        ? globalThis.Boolean(object.recognition_mode)
        : false,
      ...
      extBatStatus: isSet(object.extBatStatus)
        ...
        : 0,
      totalOperatingHours: isSet(object.totalOperatingHours)
        ? Long.fromValue(object.totalOperatingHours)
        : isSet(object.total_operating_hours)
        ? Long.fromValue(object.total_operating_hours)
        : Long.ZERO,
    };
  },
  ...
  toJSON(message: JonGuiDataSystem): unknown {
    ...
    if (!message.totalOperatingHours.equals(Long.ZERO)) {
      obj.totalOperatingHours = (message.totalOperatingHours || Long.ZERO).toString();
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<JonGuiDataSystem>, I>>(object: I): JonGuiDataSystem {
    ...
    message.totalOperatingHours = (object.totalOperatingHours !== undefined && object.totalOperatingHours !== null)
      ? Long.fromValue(object.totalOperatingHours)
      : Long.ZERO;
    return message;
  },
