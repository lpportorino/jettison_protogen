  ...
  fromJSON(object: any): Root {
    return {
      showDefaultScreen: isSet(object.showDefaultScreen)
        ...
        : isSet(object.show_default_screen)
        ? ShowDefaultScreen.fromJSON(object.show_default_screen)
        : undefined,
      showLrfMeasureScreen: isSet(object.showLrfMeasureScreen)
        ? ShowLRFMeasureScreen.fromJSON(object.showLrfMeasureScreen)
        : isSet(object.show_lrf_measure_screen)
        ? ShowLRFMeasureScreen.fromJSON(object.show_lrf_measure_screen)
        : undefined,
      showLrfResultScreen: isSet(object.showLrfResultScreen)
        ? ShowLRFResultScreen.fromJSON(object.showLrfResultScreen)
        : isSet(object.show_lrf_result_screen)
        ? ShowLRFResultScreen.fromJSON(object.show_lrf_result_screen)
        : undefined,
      showLrfResultSimplifiedScreen: isSet(object.showLrfResultSimplifiedScreen)
        ...
        : isSet(object.show_lrf_result_simplified_screen)
        ? ShowLRFResultSimplifiedScreen.fromJSON(object.show_lrf_result_simplified_screen)
        : undefined,
      enableHeatOsd: isSet(object.enableHeatOsd)
        ? EnableHeatOSD.fromJSON(object.enableHeatOsd)
        : isSet(object.enable_heat_osd)
        ? EnableHeatOSD.fromJSON(object.enable_heat_osd)
        : undefined,
      disableHeatOsd: isSet(object.disableHeatOsd)
        ? DisableHeatOSD.fromJSON(object.disableHeatOsd)
        : isSet(object.disable_heat_osd)
        ? DisableHeatOSD.fromJSON(object.disable_heat_osd)
        : undefined,
      enableDayOsd: isSet(object.enableDayOsd)
        ? EnableDayOSD.fromJSON(object.enableDayOsd)
        : isSet(object.enable_day_osd)
        ? EnableDayOSD.fromJSON(object.enable_day_osd)
        : undefined,
      disableDayOsd: isSet(object.disableDayOsd)
        ? DisableDayOSD.fromJSON(object.disableDayOsd)
        : isSet(object.disable_day_osd)
        ? DisableDayOSD.fromJSON(object.disable_day_osd)
        : undefined,
    };
  },
