...
export const Root: MessageFns<Root> = {
  encode(message: Root, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.fxRoi !== undefined) {
      FxROI.encode(message.fxRoi, writer.uint32(306).fork()).join();
    }
    if (message.sceneAuto !== undefined) {
      SceneAuto.encode(message.sceneAuto, writer.uint32(314).fork()).join();
    }
    return writer;
  },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 39: {
            ...
            message.sceneAuto = SceneAuto.decode(reader, reader.uint32());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Root {
    return {
      ...
      setAgc: isSet(object.setAgc)
        ? SetAGC.fromJSON(object.setAgc)
        : isSet(object.set_agc)
        ? SetAGC.fromJSON(object.set_agc)
        : undefined,
      setFilter: isSet(object.setFilter)
        ? SetFilters.fromJSON(object.setFilter)
        : isSet(object.set_filter)
        ? SetFilters.fromJSON(object.set_filter)
        : undefined,
      ...
      zoomIn: isSet(object.zoomIn)
        ? ZoomIn.fromJSON(object.zoomIn)
        : isSet(object.zoom_in)
        ? ZoomIn.fromJSON(object.zoom_in)
        : undefined,
      zoomOut: isSet(object.zoomOut)
        ? ZoomOut.fromJSON(object.zoomOut)
        : isSet(object.zoom_out)
        ? ZoomOut.fromJSON(object.zoom_out)
        : undefined,
      zoomStop: isSet(object.zoomStop)
        ? ZoomStop.fromJSON(object.zoomStop)
        : isSet(object.zoom_stop)
        ? ZoomStop.fromJSON(object.zoom_stop)
        : undefined,
      focusIn: isSet(object.focusIn)
        ? FocusIn.fromJSON(object.focusIn)
        : isSet(object.focus_in)
        ? FocusIn.fromJSON(object.focus_in)
        : undefined,
      focusOut: isSet(object.focusOut)
        ? FocusOut.fromJSON(object.focusOut)
        : isSet(object.focus_out)
        ? FocusOut.fromJSON(object.focus_out)
        : undefined,
      focusStop: isSet(object.focusStop)
        ? FocusStop.fromJSON(object.focusStop)
        : isSet(object.focus_stop)
        ? FocusStop.fromJSON(object.focus_stop)
        : undefined,
      calibrate: isSet(object.calibrate) ? Calibrate.fromJSON(object.calibrate) : undefined,
      setDdeLevel: isSet(object.setDdeLevel)
        ? SetDDELevel.fromJSON(object.setDdeLevel)
        : isSet(object.set_dde_level)
        ? SetDDELevel.fromJSON(object.set_dde_level)
        : undefined,
      enableDde: isSet(object.enableDde)
        ? EnableDDE.fromJSON(object.enableDde)
        : isSet(object.enable_dde)
        ? EnableDDE.fromJSON(object.enable_dde)
        : undefined,
      disableDde: isSet(object.disableDde)
        ? DisableDDE.fromJSON(object.disableDde)
        : isSet(object.disable_dde)
        ? DisableDDE.fromJSON(object.disable_dde)
        : undefined,
      ...
      focusStepMinus: isSet(object.focusStepMinus)
        ...
        : undefined,
      setFxMode: isSet(object.setFxMode)
        ? SetFxMode.fromJSON(object.setFxMode)
        : isSet(object.set_fx_mode)
        ? SetFxMode.fromJSON(object.set_fx_mode)
        : undefined,
      nextFxMode: isSet(object.nextFxMode)
        ? NextFxMode.fromJSON(object.nextFxMode)
        : isSet(object.next_fx_mode)
        ? NextFxMode.fromJSON(object.next_fx_mode)
        : undefined,
      prevFxMode: isSet(object.prevFxMode)
        ? PrevFxMode.fromJSON(object.prevFxMode)
        : isSet(object.prev_fx_mode)
        ? PrevFxMode.fromJSON(object.prev_fx_mode)
        : undefined,
      getMeteo: isSet(object.getMeteo)
        ...
        : undefined,
      shiftDde: isSet(object.shiftDde)
        ? ShiftDDE.fromJSON(object.shiftDde)
        : isSet(object.shift_dde)
        ? ShiftDDE.fromJSON(object.shift_dde)
        : undefined,
      refreshFxMode: isSet(object.refreshFxMode)
        ? RefreshFxMode.fromJSON(object.refreshFxMode)
        : isSet(object.refresh_fx_mode)
        ? RefreshFxMode.fromJSON(object.refresh_fx_mode)
        : undefined,
      resetZoom: isSet(object.resetZoom)
        ? ResetZoom.fromJSON(object.resetZoom)
        : isSet(object.reset_zoom)
        ? ResetZoom.fromJSON(object.reset_zoom)
        : undefined,
      saveToTable: isSet(object.saveToTable)
        ? SaveToTable.fromJSON(object.saveToTable)
        : isSet(object.save_to_table)
        ? SaveToTable.fromJSON(object.save_to_table)
        : undefined,
      setCalibMode: isSet(object.setCalibMode)
        ? SetCalibMode.fromJSON(object.setCalibMode)
        : isSet(object.set_calib_mode)
        ? SetCalibMode.fromJSON(object.set_calib_mode)
        : undefined,
      setDigitalZoomLevel: isSet(object.setDigitalZoomLevel)
        ? SetDigitalZoomLevel.fromJSON(object.setDigitalZoomLevel)
        : isSet(object.set_digital_zoom_level)
        ? SetDigitalZoomLevel.fromJSON(object.set_digital_zoom_level)
        : undefined,
      setClaheLevel: isSet(object.setClaheLevel)
        ? SetClaheLevel.fromJSON(object.setClaheLevel)
        : isSet(object.set_clahe_level)
        ? SetClaheLevel.fromJSON(object.set_clahe_level)
        : undefined,
      shiftClaheLevel: isSet(object.shiftClaheLevel)
        ? ShiftClaheLevel.fromJSON(object.shiftClaheLevel)
        : isSet(object.shift_clahe_level)
        ? ShiftClaheLevel.fromJSON(object.shift_clahe_level)
        : undefined,
      focusRoi: isSet(object.focusRoi)
        ? FocusROI.fromJSON(object.focusRoi)
        : isSet(object.focus_roi)
        ? FocusROI.fromJSON(object.focus_roi)
        : undefined,
      trackRoi: isSet(object.trackRoi)
        ? TrackROI.fromJSON(object.trackRoi)
        : isSet(object.track_roi)
        ? TrackROI.fromJSON(object.track_roi)
        : undefined,
      zoomRoi: isSet(object.zoomRoi)
        ? ZoomROI.fromJSON(object.zoomRoi)
        : isSet(object.zoom_roi)
        ? ZoomROI.fromJSON(object.zoom_roi)
        : undefined,
      fxRoi: isSet(object.fxRoi)
        ? FxROI.fromJSON(object.fxRoi)
        : isSet(object.fx_roi)
        ? FxROI.fromJSON(object.fx_roi)
        : undefined,
      sceneAuto: isSet(object.sceneAuto)
        ? SceneAuto.fromJSON(object.sceneAuto)
        : isSet(object.scene_auto)
        ? SceneAuto.fromJSON(object.scene_auto)
        : undefined,
    };
  },
  ...
  toJSON(message: Root): unknown {
    ...
    if (message.sceneAuto !== undefined) {
      obj.sceneAuto = SceneAuto.toJSON(message.sceneAuto);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Root>, I>>(object: I): Root {
    ...
    message.sceneAuto = (object.sceneAuto !== undefined && object.sceneAuto !== null)
      ? SceneAuto.fromPartial(object.sceneAuto)
      : undefined;
    return message;
  },
};
  ...
  fromJSON(object: any): Zoom {
    return {
      setZoomTableValue: isSet(object.setZoomTableValue)
        ...
        : isSet(object.set_zoom_table_value)
        ? SetZoomTableValue.fromJSON(object.set_zoom_table_value)
        : undefined,
      nextZoomTablePos: isSet(object.nextZoomTablePos)
        ? NextZoomTablePos.fromJSON(object.nextZoomTablePos)
        : isSet(object.next_zoom_table_pos)
        ? NextZoomTablePos.fromJSON(object.next_zoom_table_pos)
        : undefined,
      prevZoomTablePos: isSet(object.prevZoomTablePos)
        ? PrevZoomTablePos.fromJSON(object.prevZoomTablePos)
        : isSet(object.prev_zoom_table_pos)
        ? PrevZoomTablePos.fromJSON(object.prev_zoom_table_pos)
        : undefined,
    };
  },
...
function createBaseFxROI(): FxROI {
  return { x1: 0, y1: 0, x2: 0, y2: 0, frameTime: Long.UZERO, stateTime: Long.UZERO };
}

export const FxROI: MessageFns<FxROI> = {
  encode(message: FxROI, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.x1 !== 0) {
      writer.uint32(9).double(message.x1);
    }
    if (message.y1 !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FxROI {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  create<I extends Exact<DeepPartial<FxROI>, I>>(base?: I): FxROI {
    return FxROI.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FxROI>, I>>(object: I): FxROI {
    const message = createBaseFxROI();
    message.x1 = object.x1 ?? 0;
    message.y1 = object.y1 ?? 0;
    message.x2 = object.x2 ?? 0;
...
function createBaseSceneAuto(): SceneAuto {
  return { enable: false };
}

export const SceneAuto: MessageFns<SceneAuto> = {
  encode(message: SceneAuto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SceneAuto {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
    ...
    try {
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseSceneAuto();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  create<I extends Exact<DeepPartial<SceneAuto>, I>>(base?: I): SceneAuto {
    return SceneAuto.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SceneAuto>, I>>(object: I): SceneAuto {
    const message = createBaseSceneAuto();
