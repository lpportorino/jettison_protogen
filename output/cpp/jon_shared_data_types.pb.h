...
#ifndef GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5ftypes_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5ftypes_2eproto_2epb_2eh
...
class JonGuiDataMeteo final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ser.JonGuiDataMeteo) */ {
 public:
  inline JonGuiDataMeteo() : JonGuiDataMeteo(nullptr) {}
  ~JonGuiDataMeteo() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR JonGuiDataMeteo(::google::protobuf::internal::ConstantInitialized);

  inline JonGuiDataMeteo(const JonGuiDataMeteo& from)
      : JonGuiDataMeteo(nullptr, from) {}
  JonGuiDataMeteo(JonGuiDataMeteo&& from) noexcept
    : JonGuiDataMeteo() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(JonGuiDataMeteo& a, JonGuiDataMeteo& b) {
    a.Swap(&b);
  }
  ...
  JonGuiDataMeteo* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<JonGuiDataMeteo>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const JonGuiDataMeteo& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const JonGuiDataMeteo& from) {
    JonGuiDataMeteo::MergeImpl(*this, from);
  }
  private:
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5ftypes_2eproto_2epb_2eh
