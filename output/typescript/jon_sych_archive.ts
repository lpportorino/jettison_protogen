  ...
  fromJSON(object: any): SychArchiveIndex {
    return {
      ...
      createdAt: isSet(object.createdAt)
        ...
        ? Long.fromValue(object.created_at)
        : Long.UZERO,
      exportedFrom: isSet(object.exportedFrom)
        ? globalThis.String(object.exportedFrom)
        : isSet(object.exported_from)
        ? globalThis.String(object.exported_from)
        : "",
...
export const ArchiveEntry: MessageFns<ArchiveEntry> = {
  ...
  fromJSON(object: any): ArchiveEntry {
    return {
      ...
      headerOffset: isSet(object.headerOffset)
        ? Long.fromValue(object.headerOffset)
        : isSet(object.header_offset)
        ? Long.fromValue(object.header_offset)
        : Long.UZERO,
      dataOffset: isSet(object.dataOffset)
        ? Long.fromValue(object.dataOffset)
        : isSet(object.data_offset)
        ? Long.fromValue(object.data_offset)
        : Long.UZERO,
...
export const TimelineIndex: MessageFns<TimelineIndex> = {
  ...
  fromJSON(object: any): TimelineIndex {
    return {
      totalFrames: isSet(object.totalFrames)
        ? globalThis.Number(object.totalFrames)
        : isSet(object.total_frames)
        ? globalThis.Number(object.total_frames)
        : 0,
  ...
  fromJSON(object: any): VideoEntry {
    return {
      ...
      archivePath: isSet(object.archivePath)
        ? globalThis.String(object.archivePath)
        : isSet(object.archive_path)
        ? globalThis.String(object.archive_path)
        : "",
      thumbnailPath: isSet(object.thumbnailPath)
        ? globalThis.String(object.thumbnailPath)
        : isSet(object.thumbnail_path)
        ? globalThis.String(object.thumbnail_path)
        : undefined,
      globalFrameStart: isSet(object.globalFrameStart)
        ? globalThis.Number(object.globalFrameStart)
        : isSet(object.global_frame_start)
        ? globalThis.Number(object.global_frame_start)
        : 0,
...
export const OSDReference: MessageFns<OSDReference> = {
  ...
  fromJSON(object: any): OSDReference {
    return {
      packagePath: isSet(object.packagePath)
        ? globalThis.String(object.packagePath)
        : isSet(object.package_path)
        ? globalThis.String(object.package_path)
        : "",
      ...
      packageVersion: isSet(object.packageVersion)
        ...
        : "",
      packageVariant: isSet(object.packageVariant)
        ? globalThis.String(object.packageVariant)
        : isSet(object.package_variant)
        ? globalThis.String(object.package_variant)
        : "",
    };
  },
