...
static const ::_pbi::DescriptorTable* const descriptor_table_jon_5fshared_5fdata_2eproto_deps[15] =
    {
...
const ::_pbi::TcParseTable<5, 22, 15, 0, 2> JonGUIState::_table_ = {
  {
