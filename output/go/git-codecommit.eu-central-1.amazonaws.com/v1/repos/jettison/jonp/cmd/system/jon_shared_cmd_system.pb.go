...
const file_jon_shared_cmd_system_proto_rawDesc = "" +
	...
	"cmd.System\x1a\x1bjon_shared_data_types.proto\"\xd6\x06\n" +
	"\x04Root\x123\n" +
	...
	"\x15geodesic_mode_disable\x18\r \x01(\v2\x1f.cmd.System.DisableGeodesicModeH\x00R\x13geodesicModeDisableB\x05\n" +
	"\x03cmd\"\n" +
	"\n" +
	"\bStartALl\"\t\n" +
	"\aStopALl\"\b\n" +
	...
	"\x13DisableGeodesicMode\"G\n" +
	"\x0fSetLocalization\x124\n" +
	"\x03loc\x18\x01 \x01(\x0e2\".ser.JonGuiDataSystemLocalizationsR\x03locBMZKgit-codecommit.eu-central-1.amazonaws.com/v1/repos/jettison/jonp/cmd/systemb\x06proto3"
