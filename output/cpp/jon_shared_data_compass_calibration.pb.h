...
#ifndef GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5fcompass_5fcalibration_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5fcompass_5fcalibration_2eproto_2epb_2eh
...
class JonGuiDataCompassCalibration final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ser.JonGuiDataCompassCalibration) */ {
 public:
  inline JonGuiDataCompassCalibration() : JonGuiDataCompassCalibration(nullptr) {}
  ~JonGuiDataCompassCalibration() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR JonGuiDataCompassCalibration(::google::protobuf::internal::ConstantInitialized);

  inline JonGuiDataCompassCalibration(const JonGuiDataCompassCalibration& from)
      : JonGuiDataCompassCalibration(nullptr, from) {}
  JonGuiDataCompassCalibration(JonGuiDataCompassCalibration&& from) noexcept
  ...
  friend void swap(JonGuiDataCompassCalibration& a, JonGuiDataCompassCalibration& b) {
    a.Swap(&b);
  }
  ...
  JonGuiDataCompassCalibration* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<JonGuiDataCompassCalibration>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const JonGuiDataCompassCalibration& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const JonGuiDataCompassCalibration& from) {
    JonGuiDataCompassCalibration::MergeImpl(*this, from);
  }
  private:
  ...
  static ::absl::string_view FullMessageName() {
    return "ser.JonGuiDataCompassCalibration";
  }
  protected:
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_jon_5fshared_5fdata_5fcompass_5fcalibration_2eproto_2epb_2eh
