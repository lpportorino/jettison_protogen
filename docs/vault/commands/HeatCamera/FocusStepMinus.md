...
Steps thermal camera focus one increment backward (inward). Provides precise, incremental focus adjustments.
...
Steps the thermal camera focus one increment backward (inward). Each invocation moves the focus motor by a single discrete step.
