  ...
  fromJSON(object: any): Root {
    return {
      ...
      setMagneticDeclination: isSet(object.setMagneticDeclination)
        ...
        : isSet(object.set_magnetic_declination)
        ? SetMagneticDeclination.fromJSON(object.set_magnetic_declination)
        : undefined,
      setOffsetAngleAzimuth: isSet(object.setOffsetAngleAzimuth)
        ? SetOffsetAngleAzimuth.fromJSON(object.setOffsetAngleAzimuth)
        : isSet(object.set_offset_angle_azimuth)
        ? SetOffsetAngleAzimuth.fromJSON(object.set_offset_angle_azimuth)
        : undefined,
      setOffsetAngleElevation: isSet(object.setOffsetAngleElevation)
        ...
        : isSet(object.set_offset_angle_elevation)
        ? SetOffsetAngleElevation.fromJSON(object.set_offset_angle_elevation)
        : undefined,
      setUseRotaryPosition: isSet(object.setUseRotaryPosition)
        ? SetUseRotaryPosition.fromJSON(object.setUseRotaryPosition)
        : isSet(object.set_use_rotary_position)
        ? SetUseRotaryPosition.fromJSON(object.set_use_rotary_position)
        : undefined,
      startCalibrateLong: isSet(object.startCalibrateLong)
        ? CalibrateStartLong.fromJSON(object.startCalibrateLong)
        : isSet(object.start_calibrate_long)
        ? CalibrateStartLong.fromJSON(object.start_calibrate_long)
        : undefined,
      startCalibrateShort: isSet(object.startCalibrateShort)
        ? CalibrateStartShort.fromJSON(object.startCalibrateShort)
        : isSet(object.start_calibrate_short)
        ? CalibrateStartShort.fromJSON(object.start_calibrate_short)
        : undefined,
      calibrateNext: isSet(object.calibrateNext)
        ? CalibrateNext.fromJSON(object.calibrateNext)
        : isSet(object.calibrate_next)
        ? CalibrateNext.fromJSON(object.calibrate_next)
        : undefined,
      calibrateCencel: isSet(object.calibrateCencel)
        ? CalibrateCencel.fromJSON(object.calibrateCencel)
        : isSet(object.calibrate_cencel)
        ? CalibrateCencel.fromJSON(object.calibrate_cencel)
        : undefined,
