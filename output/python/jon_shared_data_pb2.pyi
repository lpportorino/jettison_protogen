...
class JonGUIState(_message.Message):
    __slots__ = ("protocol_version", "system_monotonic_time_us", "system", "meteo_internal", "lrf", "time", "gps", "compass", "rotary", "camera_day", "camera_heat", "compass_calibration", "rec_osd", "day_cam_glass_heater", "actual_space_time", "power")
