...
type Root_SceneAuto struct {
	SceneAuto *SceneAuto `protobuf:"bytes,23,opt,name=scene_auto,json=sceneAuto,proto3,oneof"`
}
...
func (x *SceneAuto) Reset() {
	*x = SceneAuto{}
	mi := &file_jon_shared_cmd_day_camera_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SceneAuto) Descriptor() ([]byte, []int) {
	return file_jon_shared_cmd_day_camera_proto_rawDescGZIP(), []int{39}
}
...
const file_jon_shared_cmd_day_camera_proto_rawDesc = "" +
	...
	"\x05value\x18\x01 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\xf0?)\x00\x00\x00\x00\x00\x00\xf0\xbfR\x05value\"\xf1\n" +
	"\n" +
	"\x04Root\x12,\n" +
	...
	"\rset_auto_gain\x18\x16 \x01(\v2\x1a.cmd.DayCamera.SetAutoGainH\x00R\vsetAutoGain\x129\n" +
	"\n" +
	"scene_auto\x18\x17 \x01(\v2\x18.cmd.DayCamera.SceneAutoH\x00R\tsceneAutoB\f\n" +
	...
	"\tSceneAuto\x12\x16\n" +
	"\x06enable\x18\x01 \x01(\bR\x06enableB\xd5\x01\n" +
...
var file_jon_shared_cmd_day_camera_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_jon_shared_cmd_day_camera_proto_goTypes = []any{
	...
	(*SceneAuto)(nil),              // 39: cmd.DayCamera.SceneAuto
	(types.JonGuiDataFxModeDay)(0), // 40: ser.JonGuiDataFxModeDay
}
var file_jon_shared_cmd_day_camera_proto_depIdxs = []int32{
	...
	39, // 22: cmd.DayCamera.Root.scene_auto:type_name -> cmd.DayCamera.SceneAuto
	40, // 23: cmd.DayCamera.SetFxMode.mode:type_name -> ser.JonGuiDataFxModeDay
	0,  // 24: cmd.DayCamera.Focus.set_value:type_name -> cmd.DayCamera.SetValue
	1,  // 25: cmd.DayCamera.Focus.move:type_name -> cmd.DayCamera.Move
	25, // 26: cmd.DayCamera.Focus.halt:type_name -> cmd.DayCamera.Halt
	2,  // 27: cmd.DayCamera.Focus.offset:type_name -> cmd.DayCamera.Offset
	28, // 28: cmd.DayCamera.Focus.reset_focus:type_name -> cmd.DayCamera.ResetFocus
	30, // 29: cmd.DayCamera.Focus.save_to_table_focus:type_name -> cmd.DayCamera.SaveToTableFocus
	31, // 30: cmd.DayCamera.Focus.focus_step_plus:type_name -> cmd.DayCamera.FocusStepPlus
	32, // 31: cmd.DayCamera.Focus.focus_step_minus:type_name -> cmd.DayCamera.FocusStepMinus
	0,  // 32: cmd.DayCamera.Zoom.set_value:type_name -> cmd.DayCamera.SetValue
	1,  // 33: cmd.DayCamera.Zoom.move:type_name -> cmd.DayCamera.Move
	25, // 34: cmd.DayCamera.Zoom.halt:type_name -> cmd.DayCamera.Halt
	21, // 35: cmd.DayCamera.Zoom.set_zoom_table_value:type_name -> cmd.DayCamera.SetZoomTableValue
	15, // 36: cmd.DayCamera.Zoom.next_zoom_table_pos:type_name -> cmd.DayCamera.NextZoomTablePos
	16, // 37: cmd.DayCamera.Zoom.prev_zoom_table_pos:type_name -> cmd.DayCamera.PrevZoomTablePos
	2,  // 38: cmd.DayCamera.Zoom.offset:type_name -> cmd.DayCamera.Offset
	27, // 39: cmd.DayCamera.Zoom.reset_zoom:type_name -> cmd.DayCamera.ResetZoom
	29, // 40: cmd.DayCamera.Zoom.save_to_table:type_name -> cmd.DayCamera.SaveToTable
	33, // 41: cmd.DayCamera.Zoom.zoom_step_plus:type_name -> cmd.DayCamera.ZoomStepPlus
	34, // 42: cmd.DayCamera.Zoom.zoom_step_minus:type_name -> cmd.DayCamera.ZoomStepMinus
