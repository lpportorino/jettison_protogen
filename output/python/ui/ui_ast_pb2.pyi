...
class WidgetType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    WIDGET_TARGET_OVERLAY: _ClassVar[WidgetType]
...
WIDGET_TARGET_OVERLAY: WidgetType
...
class WidgetNode(_message.Message):
    ...
    TARGET_OVERLAY_PROPS_FIELD_NUMBER: _ClassVar[int]
    ...
    PENDING_WHEN_FIELD_NUMBER: _ClassVar[int]
    COLOR_WHEN_FIELD_NUMBER: _ClassVar[int]
    HIT_SLOP_FIELD_NUMBER: _ClassVar[int]
    DESIGNED_OVERLAY_FIELD_NUMBER: _ClassVar[int]
    ...
    pending_when: VisibilityBinding
...
class TargetBox(_message.Message):
    __slots__ = ("x", "y", "w", "h", "label", "color")
    X_FIELD_NUMBER: _ClassVar[int]
    Y_FIELD_NUMBER: _ClassVar[int]
    ...
    label: str
    color: Color
    def __init__(self, x: _Optional[int] = ..., y: _Optional[int] = ..., w: _Optional[int] = ..., h: _Optional[int] = ..., label: _Optional[str] = ..., color: _Optional[_Union[Color, _Mapping]] = ...) -> None: ...

class TargetOverlayProps(_message.Message):
    __slots__ = ("boxes", "border_width", "hide_labels")
...
class ColorBinding(_message.Message):
    __slots__ = ("when", "color")
    WHEN_FIELD_NUMBER: _ClassVar[int]
    COLOR_FIELD_NUMBER: _ClassVar[int]
    when: VisibilityBinding
    color: Color
    def __init__(self, when: _Optional[_Union[VisibilityBinding, _Mapping]] = ..., color: _Optional[_Union[Color, _Mapping]] = ...) -> None: ...
