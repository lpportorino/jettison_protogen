...
const file_jon_shared_data_pmu_proto_rawDesc = "" +
	...
	"inaVoltage\x128\n" +
	"\vina_current\x18\b \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x88\xc3@)\x00\x00\x00\x00\x00\x88\xc3\xc0R\n" +
	"inaCurrent\x124\n" +
	"\tina_power\x18\t \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00j\xf8@)\x00\x00\x00\x00\x00\x00\x00\x00R\binaPower\x12&\n" +
