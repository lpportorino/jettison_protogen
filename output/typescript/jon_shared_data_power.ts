...
export const JonGuiDataPowerModule: MessageFns<JonGuiDataPowerModule> = {
  ...
  fromJSON(object: any): JonGuiDataPowerModule {
    return {
      ...
      isOn: isSet(object.isOn)
        ? globalThis.Boolean(object.isOn)
        : isSet(object.is_on)
        ? globalThis.Boolean(object.is_on)
        : false,
      hasAlarm: isSet(object.hasAlarm)
        ? globalThis.Boolean(object.hasAlarm)
        : isSet(object.has_alarm)
        ? globalThis.Boolean(object.has_alarm)
        : false,
    };
  },
