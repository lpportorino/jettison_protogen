...
const ::uint32_t
    TableStruct_jon_5fshared_5fcmd_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::cmd::Root, _impl_.opaque_payloads_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {38, -1, -1, sizeof(::cmd::Ping)},
        {46, -1, -1, sizeof(::cmd::Noop)},
        {54, -1, -1, sizeof(::cmd::Frozen)},
};
...
static const ::_pbi::DescriptorTable* const descriptor_table_jon_5fshared_5fcmd_2eproto_deps[17] =
    {
...
void Root::clear_opaque_payloads() {
...
void Root::set_allocated_pmu(::cmd::PMU::Root* pmu) {
  ::google::protobuf::Arena* message_arena = GetArena();
  clear_payload();
  if (pmu) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::google::protobuf::MessageLite*>(pmu)->GetArena();
    if (message_arena != submessage_arena) {
      pmu = ::google::protobuf::internal::GetOwnedMessage(message_arena, pmu, submessage_arena);
    }
    set_has_pmu();
    _impl_.payload_.pmu_ = pmu;
  }
  // @@protoc_insertion_point(field_set_allocated:cmd.Root.pmu)
}
void Root::clear_pmu() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (payload_case() == kPmu) {
    if (GetArena() == nullptr) {
      delete _impl_.payload_.pmu_;
    } else if (::google::protobuf::internal::DebugHardenClearOneofMessageOnArena()) {
      ::google::protobuf::internal::MaybePoisonAfterClear(_impl_.payload_.pmu_);
    }
    clear_has_payload();
  }
}
void Root::set_allocated_heater(::cmd::Heater::Root* heater) {
  ::google::protobuf::Arena* message_arena = GetArena();
  clear_payload();
  if (heater) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::google::protobuf::MessageLite*>(heater)->GetArena();
    if (message_arena != submessage_arena) {
      heater = ::google::protobuf::internal::GetOwnedMessage(message_arena, heater, submessage_arena);
    }
    set_has_heater();
    _impl_.payload_.heater_ = heater;
  }
  // @@protoc_insertion_point(field_set_allocated:cmd.Root.heater)
}
void Root::clear_heater() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (payload_case() == kHeater) {
    if (GetArena() == nullptr) {
      delete _impl_.payload_.heater_;
    } else if (::google::protobuf::internal::DebugHardenClearOneofMessageOnArena()) {
      ::google::protobuf::internal::MaybePoisonAfterClear(_impl_.payload_.heater_);
    }
    clear_has_payload();
  }
}
  ...
  switch (payload_case()) {
    case PAYLOAD_NOT_SET:
      ...
      case kPower:
        ...
        break;
      case kPmu:
        _impl_.payload_.pmu_ = ::google::protobuf::Message::CopyConstruct<::cmd::PMU::Root>(arena, *from._impl_.payload_.pmu_);
        break;
      case kHeater:
        _impl_.payload_.heater_ = ::google::protobuf::Message::CopyConstruct<::cmd::Heater::Root>(arena, *from._impl_.payload_.heater_);
        break;
  }
...
constexpr auto Root::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(Root, _impl_.opaque_payloads_) +
          decltype(Root::_impl_.opaque_payloads_)::
...
const ::_pbi::TcParseTable<4, 29, 19, 0, 7> Root::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastMtR1,
     {90, 63, 0, PROTOBUF_FIELD_OFFSET(Root, _impl_.opaque_payloads_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
    // repeated .ser.JonOpaquePayload opaque_payloads = 11;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.opaque_payloads_), 0, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.DayCamera.Root day_camera = 20;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.day_camera_), _Internal::kOneofCaseOffset + 0, 1,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.HeatCamera.Root heat_camera = 21;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.heat_camera_), _Internal::kOneofCaseOffset + 0, 2,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Gps.Root gps = 22;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.gps_), _Internal::kOneofCaseOffset + 0, 3,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Compass.Root compass = 23;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.compass_), _Internal::kOneofCaseOffset + 0, 4,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Lrf.Root lrf = 24;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.lrf_), _Internal::kOneofCaseOffset + 0, 5,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Lrf_calib.Root lrf_calib = 25;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.lrf_calib_), _Internal::kOneofCaseOffset + 0, 6,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.RotaryPlatform.Root rotary = 26;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.rotary_), _Internal::kOneofCaseOffset + 0, 7,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.OSD.Root osd = 27;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.osd_), _Internal::kOneofCaseOffset + 0, 8,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Ping ping = 28;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.ping_), _Internal::kOneofCaseOffset + 0, 9,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Noop noop = 29;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.noop_), _Internal::kOneofCaseOffset + 0, 10,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Frozen frozen = 30;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.frozen_), _Internal::kOneofCaseOffset + 0, 11,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.System.Root system = 31;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.system_), _Internal::kOneofCaseOffset + 0, 12,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.CV.Root cv = 32;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.cv_), _Internal::kOneofCaseOffset + 0, 13,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.DayCamGlassHeater.Root day_cam_glass_heater = 33;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.day_cam_glass_heater_), _Internal::kOneofCaseOffset + 0, 14,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Lira.Root lira = 34;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.lira_), _Internal::kOneofCaseOffset + 0, 15,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Power.Root power = 35;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.power_), _Internal::kOneofCaseOffset + 0, 16,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.PMU.Root pmu = 36;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.pmu_), _Internal::kOneofCaseOffset + 0, 17,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .cmd.Heater.Root heater = 37;
    {PROTOBUF_FIELD_OFFSET(Root, _impl_.payload_.heater_), _Internal::kOneofCaseOffset + 0, 18,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
  }}, {{
    ...
    {::_pbi::TcParser::GetTable<::cmd::PMU::Root>()},
    {::_pbi::TcParser::GetTable<::cmd::Heater::Root>()},
  }}, {{
  }},
};
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Root::_InternalSerialize(
          ...
          switch (this_.payload_case()) {
            ...
            case kPmu: {
              target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
                  36, *this_._impl_.payload_.pmu_, this_._impl_.payload_.pmu_->GetCachedSize(), target,
                  stream);
              break;
            }
            case kHeater: {
              target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
                  37, *this_._impl_.payload_.heater_, this_._impl_.payload_.heater_->GetCachedSize(), target,
                  stream);
              break;
            }
            default:
        ...
        ::size_t Root::ByteSizeLong() const {
          ...
          switch (this_.payload_case()) {
            ...
            case kPmu: {
              total_size += 2 +
                            ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.payload_.pmu_);
              break;
            }
            // .cmd.Heater.Root heater = 37;
            case kHeater: {
              total_size += 2 +
                            ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.payload_.heater_);
              break;
            }
            case PAYLOAD_NOT_SET: {
              break;
...
void Root::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (const uint32_t oneof_from_case = from._impl_._oneof_case_[0]) {
    ...
    switch (oneof_from_case) {
      ...
      case kPmu: {
        if (oneof_needs_init) {
          _this->_impl_.payload_.pmu_ =
              ::google::protobuf::Message::CopyConstruct<::cmd::PMU::Root>(arena, *from._impl_.payload_.pmu_);
        } else {
          _this->_impl_.payload_.pmu_->MergeFrom(from._internal_pmu());
        }
        break;
      }
      case kHeater: {
        if (oneof_needs_init) {
          _this->_impl_.payload_.heater_ =
              ::google::protobuf::Message::CopyConstruct<::cmd::Heater::Root>(arena, *from._impl_.payload_.heater_);
        } else {
          _this->_impl_.payload_.heater_->MergeFrom(from._internal_heater());
        }
        break;
      }
      case PAYLOAD_NOT_SET:
