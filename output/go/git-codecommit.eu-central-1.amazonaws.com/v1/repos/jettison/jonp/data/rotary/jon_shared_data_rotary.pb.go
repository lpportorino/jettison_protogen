...
type JonGuiDataRotary struct {
	...
	IsParked      bool `protobuf:"varint,23,opt,name=is_parked,json=isParked,proto3" json:"is_parked,omitempty"`
...
func (x *JonGuiDataRotary) GetPanInitStatus() int32 {
	if x != nil {
		return x.PanInitStatus
	}
	return 0
}

func (x *JonGuiDataRotary) GetTiltInitStatus() int32 {
	if x != nil {
		return x.TiltInitStatus
	}
	return 0
}
...
func (x *JonGuiDataRotary) GetIsParked() bool {
	if x != nil {
		return x.IsParked
	}
	return false
...
const file_jon_shared_data_rotary_proto_rawDesc = "" +
	"\n" +
	"\x1cjon_shared_data_rotary.proto\x12\x03ser\x1a\x1bbuf/validate/validate.proto\x1a\x1bjon_shared_data_types.proto\"\xf7\v\n" +
	...
	"sunAzimuth\x12`\n" +
	"\rsun_elevation\x18\x10 \x01(\x01B;\xbaH8\x126I\x00\x00\x00\x00\x00\x00\x00\x00I\x00\x00\x00\x00\x00\x80V@I\x00\x00\x00\x00\x00\x80f@I\x00\x00\x00\x00\x00\xe0p@\x11\x00\x00\x00\x00\x00\x80v@)\x00\x00\x00\x00\x00\x00\x00\x00R\fsunElevation\x129\n" +
	"\x11current_scan_node\x18\x11 \x01(\v2\r.ser.ScanNodeR\x0fcurrentScanNode\x12\x1d\n" +
	"\n" +
	...
	"\x14capture_monotonic_us\x18\x16 \x01(\x04R\x12captureMonotonicUs\x12\x1b\n" +
	"\tis_parked\x18\x17 \x01(\bR\bisParked\"\xda\x02\n" +
	"\bScanNode\x12\x1d\n" +
