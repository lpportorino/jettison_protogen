...
class Root(_message.Message):
    __slots__ = ("protocol_version", "session_id", "important", "from_cv_subsystem", "client_type", "frame_time_day", "frame_time_heat", "state_time", "client_time_ms", "day_camera", "heat_camera", "gps", "compass", "lrf", "lrf_calib", "rotary", "osd", "ping", "noop", "frozen", "system", "cv", "day_cam_glass_heater", "lira")
