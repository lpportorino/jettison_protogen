...
const file_jon_shared_cmd_rotary_proto_rawDesc = "" +
	...
	"\x04flag\x18\x01 \x01(\bR\x04flag\"\x85\x01\n" +
	"\vRotateToGPS\x12+\n" +
	...
	"\n" +
	"\x15\x00\x004C-\x00\x004\xc3R\tlongitude\x12\x1a\n" +
	"\baltitude\x18\x03 \x01(\x02R\baltitude\"\x86\x01\n" +
	"\fSetOriginGPS\x12+\n" +
	"\blatitude\x18\x01 \x01(\x02B\x0f\xbaH\f\n" +
	"\n" +
	"\x1d\x00\x00\xb4B-\x00\x00\xb4\xc2R\blatitude\x12-\n" +
	...
	"\n" +
	"\x15\x00\x004C-\x00\x004\xc3R\tlongitude\x12\x1a\n" +
	"\baltitude\x18\x03 \x01(\x02R\baltitude\"\x8e\x01\n" +
	"\vRotateToNDC\x12A\n" +
	...
	"\n" +
	"\x1d\x00\x00\x80?-\x00\x00\x80\xbfR\x01yBMZKgit-codecommit.eu-central-1.amazonaws.com/v1/repos/jettison/jonp/cmd/rotaryb\x06proto3"
