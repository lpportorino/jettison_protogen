...
type PatchOpKind int32

const (
	PatchOpKind_PATCH_OP_UPDATE_PROPS PatchOpKind = 0 // morph target in place from node's props
	PatchOpKind_PATCH_OP_REPLACE_NODE PatchOpKind = 1 // teardown target subtree, build node in slot
	PatchOpKind_PATCH_OP_INSERT_NODE  PatchOpKind = 2 // build node under parent_uid at index
	PatchOpKind_PATCH_OP_REMOVE_NODE  PatchOpKind = 3 // teardown target subtree
	PatchOpKind_PATCH_OP_MOVE_NODE    PatchOpKind = 4 // reorder target to index (same parent)
)

// Enum value maps for PatchOpKind.
var (
	PatchOpKind_name = map[int32]string{
		0: "PATCH_OP_UPDATE_PROPS",
		1: "PATCH_OP_REPLACE_NODE",
		2: "PATCH_OP_INSERT_NODE",
		3: "PATCH_OP_REMOVE_NODE",
		4: "PATCH_OP_MOVE_NODE",
	}
	PatchOpKind_value = map[string]int32{
...
func (x PatchOpKind) Enum() *PatchOpKind {
	p := new(PatchOpKind)
	*p = x
	return p
}

func (x PatchOpKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PatchOpKind) Descriptor() protoreflect.EnumDescriptor {
	return file_ui_ui_ast_proto_enumTypes[1].Descriptor()
}

func (PatchOpKind) Type() protoreflect.EnumType {
	return &file_ui_ui_ast_proto_enumTypes[1]
}

func (x PatchOpKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PatchOpKind.Descriptor instead.
func (PatchOpKind) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	WidgetType_WIDGET_HOST_PROXY     WidgetType = 21
	WidgetType_WIDGET_TARGET_OVERLAY WidgetType = 22
)
...
var (
	WidgetType_name = map[int32]string{
		...
		19: "WIDGET_TABVIEW",
		20: "WIDGET_CHART",
		21: "WIDGET_HOST_PROXY",
		22: "WIDGET_TARGET_OVERLAY",
	}
...
const (
	ProxyMode_PROXY_MODE_STATIC    ProxyMode = 0 // host element interactive; proxy inert
	ProxyMode_PROXY_MODE_DRAGGABLE ProxyMode = 1 // body drag moves the box
	ProxyMode_PROXY_MODE_RESIZABLE ProxyMode = 2 // corner handles resize; body drag moves
	ProxyMode_PROXY_MODE_ALIGNABLE ProxyMode = 3 // 3x3 snap grid; no free drag
)
...
var (
	ProxyMode_name = map[int32]string{
		0: "PROXY_MODE_STATIC",
		1: "PROXY_MODE_DRAGGABLE",
		2: "PROXY_MODE_RESIZABLE",
		3: "PROXY_MODE_ALIGNABLE",
	}
...
const (
	...
	PatchKind_PATCH_KIND_NDC_Y        PatchKind = 2
	...
	PatchKind_PATCH_KIND_NDC_Y2       PatchKind = 6 // ROI rubber-band 2nd-corner NDC y → a double slot, oriented as NDC_Y is
...
var (
	PatchKind_name = map[int32]string{
		0: "PATCH_KIND_UNSPECIFIED",
		1: "PATCH_KIND_NDC_X",
		2: "PATCH_KIND_NDC_Y",
		3: "PATCH_KIND_DELTA",
...
func (x PatchKind) Enum() *PatchKind {
	p := new(PatchKind)
	*p = x
	return p
}

func (x PatchKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PatchKind) Descriptor() protoreflect.EnumDescriptor {
	return file_ui_ui_ast_proto_enumTypes[5].Descriptor()
}

func (PatchKind) Type() protoreflect.EnumType {
	return &file_ui_ui_ast_proto_enumTypes[5]
}

func (x PatchKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
const (
	...
	NdcYSense_NDC_Y_SENSE_UNSPECIFIED NdcYSense = 0
	// `+1.0` at the TOP — the pointer plane. The y is written verbatim.
	NdcYSense_NDC_Y_SENSE_UP NdcYSense = 1
	...
	NdcYSense_NDC_Y_SENSE_DOWN NdcYSense = 2
)

// Enum value maps for NdcYSense.
var (
	NdcYSense_name = map[int32]string{
		0: "NDC_Y_SENSE_UNSPECIFIED",
		1: "NDC_Y_SENSE_UP",
		2: "NDC_Y_SENSE_DOWN",
	}
	NdcYSense_value = map[string]int32{
...
func (x NdcYSense) Enum() *NdcYSense {
	p := new(NdcYSense)
	*p = x
	return p
}

func (x NdcYSense) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NdcYSense) Descriptor() protoreflect.EnumDescriptor {
	return file_ui_ui_ast_proto_enumTypes[7].Descriptor()
}

func (NdcYSense) Type() protoreflect.EnumType {
	return &file_ui_ui_ast_proto_enumTypes[7]
}

func (x NdcYSense) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use NdcYSense.Descriptor instead.
func (NdcYSense) EnumDescriptor() ([]byte, []int) {
...
type GestureKind int32

const (
	GestureKind_GESTURE_KIND_PAN_MOVE GestureKind = 0 // → cmd.RotaryPlatform.Axis (continuous slew)
...
var (
	GestureKind_name = map[int32]string{
		0: "GESTURE_KIND_PAN_MOVE",
		1: "GESTURE_KIND_PAN_END",
		2: "GESTURE_KIND_TAP",
...
func (x GestureKind) Enum() *GestureKind {
	p := new(GestureKind)
	*p = x
	return p
}

func (x GestureKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
func (StylePropertyType) Descriptor() protoreflect.EnumDescriptor {
	return file_ui_ui_ast_proto_enumTypes[29].Descriptor()
}

func (StylePropertyType) Type() protoreflect.EnumType {
	return &file_ui_ui_ast_proto_enumTypes[29]
}
...
type WidgetNode struct {
	...
	//	*WidgetNode_HostProxyProps
	//	*WidgetNode_TargetOverlayProps
...
func (x *WidgetNode) GetHostProxyProps() *HostProxyProps {
	if x != nil {
		if x, ok := x.WidgetProps.(*WidgetNode_HostProxyProps); ok {
			return x.HostProxyProps
		}
	}
	return nil
}

func (x *WidgetNode) GetTargetOverlayProps() *TargetOverlayProps {
	if x != nil {
		if x, ok := x.WidgetProps.(*WidgetNode_TargetOverlayProps); ok {
			return x.TargetOverlayProps
		}
	}
	return nil
}
...
func (x *WidgetNode) GetGestures() []*GestureSpec {
	if x != nil {
		return x.Gestures
	}
	return nil
...
type WidgetNode_HostProxyProps struct {
	HostProxyProps *HostProxyProps `protobuf:"bytes,41,opt,name=host_proxy_props,json=hostProxyProps,proto3,oneof"`
}

type WidgetNode_TargetOverlayProps struct {
	TargetOverlayProps *TargetOverlayProps `protobuf:"bytes,48,opt,name=target_overlay_props,json=targetOverlayProps,proto3,oneof"`
}
...
func (*WidgetNode_HostProxyProps) isWidgetNode_WidgetProps() {}

func (*WidgetNode_TargetOverlayProps) isWidgetNode_WidgetProps() {}

type TreePatchOp struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	Kind      PatchOpKind            `protobuf:"varint,1,opt,name=kind,proto3,enum=ui.PatchOpKind" json:"kind,omitempty"`
	TargetUid uint32                 `protobuf:"varint,2,opt,name=target_uid,json=targetUid,proto3" json:"target_uid,omitempty"` // UPDATE / REPLACE / REMOVE / MOVE
	ParentUid uint32                 `protobuf:"varint,3,opt,name=parent_uid,json=parentUid,proto3" json:"parent_uid,omitempty"` // INSERT / MOVE destination
	Index     uint32                 `protobuf:"varint,4,opt,name=index,proto3" json:"index,omitempty"`                          // INSERT / MOVE child slot
	...
	Node          *WidgetNode `protobuf:"bytes,5,opt,name=node,proto3,oneof" json:"node,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TreePatchOp) Reset() {
	*x = TreePatchOp{}
...
func (x *TreePatchOp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TreePatchOp) ProtoMessage() {}

func (x *TreePatchOp) ProtoReflect() protoreflect.Message {
	mi := &file_ui_ui_ast_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TreePatchOp.ProtoReflect.Descriptor instead.
func (*TreePatchOp) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{5}
}

func (x *TreePatchOp) GetKind() PatchOpKind {
	if x != nil {
		return x.Kind
	}
	return PatchOpKind_PATCH_OP_UPDATE_PROPS
}

func (x *TreePatchOp) GetTargetUid() uint32 {
	if x != nil {
		return x.TargetUid
	}
	return 0
...
func (x *TreePatchOp) GetParentUid() uint32 {
	if x != nil {
		return x.ParentUid
	}
	return 0
...
func (x *TreePatchOp) GetIndex() uint32 {
	if x != nil {
		return x.Index
	}
	return 0
...
func (x *TreePatchOp) GetNode() *WidgetNode {
	if x != nil {
		return x.Node
	}
	return nil
...
type ScreenPatch struct {
	...
	BaseHash uint32 `protobuf:"varint,1,opt,name=base_hash,json=baseHash,proto3" json:"base_hash,omitempty"`
	// Hash of the target full .pb; becomes the current-state hash after a
	// successful apply.
	TargetHash    uint32         `protobuf:"varint,2,opt,name=target_hash,json=targetHash,proto3" json:"target_hash,omitempty"`
	Ops           []*TreePatchOp `protobuf:"bytes,3,rep,name=ops,proto3" json:"ops,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ScreenPatch) GetBaseHash() uint32 {
	if x != nil {
		return x.BaseHash
	}
	return 0
...
func (x *ScreenPatch) GetTargetHash() uint32 {
	if x != nil {
		return x.TargetHash
	}
	return 0
...
func (x *ScreenPatch) GetOps() []*TreePatchOp {
	if x != nil {
		return x.Ops
	}
	return nil
...
type HostProxyProps struct {
	...
	// interprets it.
	Z             int32 `protobuf:"varint,8,opt,name=z,proto3" json:"z,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *HostProxyProps) Reset() {
	*x = HostProxyProps{}
...
func (x *HostProxyProps) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HostProxyProps) ProtoMessage() {}

func (x *HostProxyProps) ProtoReflect() protoreflect.Message {
	mi := &file_ui_ui_ast_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HostProxyProps.ProtoReflect.Descriptor instead.
func (*HostProxyProps) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{30}
}

func (x *HostProxyProps) GetProxyId() string {
	if x != nil {
		return x.ProxyId
	}
	return ""
...
func (x *HostProxyProps) GetMode() ProxyMode {
	if x != nil {
		return x.Mode
	}
	return ProxyMode_PROXY_MODE_STATIC
}

func (x *HostProxyProps) GetMinW() int32 {
	if x != nil {
		return x.MinW
	}
	return 0
...
func (x *HostProxyProps) GetMinH() int32 {
	if x != nil {
		return x.MinH
	}
	return 0
...
func (x *HostProxyProps) GetMaxW() int32 {
	if x != nil {
		return x.MaxW
	}
	return 0
...
func (x *HostProxyProps) GetMaxH() int32 {
	if x != nil {
		return x.MaxH
	}
	return 0
...
func (x *HostProxyProps) GetHandleSize() uint32 {
	if x != nil {
		return x.HandleSize
	}
	return 0
...
func (x *HostProxyProps) GetZ() int32 {
	if x != nil {
		return x.Z
	}
	return 0
...
func (x *TargetBox) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetBox) ProtoMessage() {}

func (x *TargetBox) ProtoReflect() protoreflect.Message {
	mi := &file_ui_ui_ast_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetBox.ProtoReflect.Descriptor instead.
func (*TargetBox) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{31}
}

func (x *TargetBox) GetX() int32 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *TargetBox) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *TargetBox) GetColor() *Color {
	if x != nil {
		return x.Color
	}
	return nil
...
type TargetOverlayProps struct {
	...
	HideLabels    bool `protobuf:"varint,3,opt,name=hide_labels,json=hideLabels,proto3" json:"hide_labels,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TargetOverlayProps) Reset() {
	*x = TargetOverlayProps{}
	mi := &file_ui_ui_ast_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TargetOverlayProps) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetOverlayProps) ProtoMessage() {}

func (x *TargetOverlayProps) ProtoReflect() protoreflect.Message {
	mi := &file_ui_ui_ast_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetOverlayProps.ProtoReflect.Descriptor instead.
func (*TargetOverlayProps) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{32}
}

func (x *TargetOverlayProps) GetBoxes() []*TargetBox {
	if x != nil {
		return x.Boxes
	}
	return nil
...
func (x *TargetOverlayProps) GetHideLabels() bool {
	if x != nil {
		return x.HideLabels
	}
	return false
...
func (x *FieldPatch) GetByteOffset() uint32 {
	if x != nil {
		return x.ByteOffset
	}
	return 0
...
func (x *FieldPatch) GetByteWidth() uint32 {
	if x != nil {
		return x.ByteWidth
	}
	return 0
...
func (x *FieldPatch) GetKind() PatchKind {
	if x != nil {
		return x.Kind
	}
	return PatchKind_PATCH_KIND_UNSPECIFIED
}

func (x *FieldPatch) GetWireScale() int32 {
	if x != nil {
		return x.WireScale
	}
	return 0
...
type CmdSpec struct {
	...
	NdcYSense     NdcYSense `protobuf:"varint,4,opt,name=ndc_y_sense,json=ndcYSense,proto3,enum=ui.NdcYSense" json:"ndc_y_sense,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CmdSpec) Reset() {
	*x = CmdSpec{}
...
func (x *CmdSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CmdSpec) ProtoMessage() {}

func (x *CmdSpec) ProtoReflect() protoreflect.Message {
	mi := &file_ui_ui_ast_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CmdSpec.ProtoReflect.Descriptor instead.
func (*CmdSpec) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{36}
}

func (x *CmdSpec) GetCommandId() string {
	if x != nil {
		return x.CommandId
	}
	return ""
...
func (x *CmdSpec) GetRootTemplate() []byte {
	if x != nil {
		return x.RootTemplate
	}
	return nil
}

func (x *CmdSpec) GetPatches() []*FieldPatch {
	if x != nil {
		return x.Patches
	}
	return nil
...
func (x *CmdSpec) GetNdcYSense() NdcYSense {
	if x != nil {
		return x.NdcYSense
	}
	return NdcYSense_NDC_Y_SENSE_UNSPECIFIED
}
...
func (x *GestureSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GestureSpec) ProtoMessage() {}

func (x *GestureSpec) ProtoReflect() protoreflect.Message {
	mi := &file_ui_ui_ast_proto_msgTypes[37]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GestureSpec.ProtoReflect.Descriptor instead.
func (*GestureSpec) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{37}
}

func (x *GestureSpec) GetKind() GestureKind {
	if x != nil {
		return x.Kind
	}
	return GestureKind_GESTURE_KIND_PAN_MOVE
}

func (x *GestureSpec) GetCmd() *CmdSpec {
	if x != nil {
		return x.Cmd
	}
	return nil
...
func (x *Color) Reset() {
	*x = Color{}
	mi := &file_ui_ui_ast_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Color) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{44}
}
...
func (x *ShadowBundle) Reset() {
	*x = ShadowBundle{}
	mi := &file_ui_ui_ast_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ShadowBundle) Descriptor() ([]byte, []int) {
	return file_ui_ui_ast_proto_rawDescGZIP(), []int{45}
}
...
const file_ui_ui_ast_proto_rawDesc = "" +
	...
	"chartProps\x12>\n" +
	"\x10host_proxy_props\x18) \x01(\v2\x12.ui.HostProxyPropsH\x00R\x0ehostProxyProps\x12J\n" +
	"\x14target_overlay_props\x180 \x01(\v2\x16.ui.TargetOverlayPropsH\x00R\x12targetOverlayProps\x125\n" +
	"\n" +
	...
	"\n" +
	"target_uid\x18\x02 \x01(\rR\ttargetUid\x12\x1d\n" +
	"\n" +
	"parent_uid\x18\x03 \x01(\rR\tparentUid\x12\x14\n" +
	"\x05index\x18\x04 \x01(\rR\x05index\x12'\n" +
	"\x04node\x18\x05 \x01(\v2\x0e.ui.WidgetNodeH\x00R\x04node\x88\x01\x01B\a\n" +
	"\x05_node\"n\n" +
	"\vScreenPatch\x12\x1b\n" +
	"\tbase_hash\x18\x01 \x01(\rR\bbaseHash\x12\x1f\n" +
	"\vtarget_hash\x18\x02 \x01(\rR\n" +
	"targetHash\x12!\n" +
	"\x03ops\x18\x03 \x03(\v2\x0f.ui.TreePatchOpR\x03ops\"\n" +
	"\n" +
	"\bObjProps\"\r\n" +
	"\vButtonProps\"F\n" +
	"\n" +
	...
	"\tfade_area\x18\a \x01(\bR\bfadeArea\"\xe6\x01\n" +
	"\x0eHostProxyProps\x12$\n" +
	"\bproxy_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18?R\aproxyId\x12+\n" +
	"\x04mode\x18\x02 \x01(\x0e2\r.ui.ProxyModeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04mode\x12\x13\n" +
	"\x05min_w\x18\x03 \x01(\x05R\x04minW\x12\x13\n" +
	"\x05min_h\x18\x04 \x01(\x05R\x04minH\x12\x13\n" +
	"\x05max_w\x18\x05 \x01(\x05R\x04maxW\x12\x13\n" +
	"\x05max_h\x18\x06 \x01(\x05R\x04maxH\x12\x1f\n" +
	"\vhandle_size\x18\a \x01(\rR\n" +
	"handleSize\x12\f\n" +
	"\x01z\x18\b \x01(\x05R\x01z\"\x83\x01\n" +
	"\tTargetBox\x12\f\n" +
	...
	"\bencoding\x18\x06 \x01(\x0e2\x11.ui.PatchEncodingB\b\xbaH\x05\x82\x01\x02\x10\x01R\bencoding\"\xc3\x01\n" +
	"\aCmdSpec\x12&\n" +
	"\n" +
	"command_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x18\x7fR\tcommandId\x12#\n" +
	"\rroot_template\x18\x02 \x01(\fR\frootTemplate\x122\n" +
	"\apatches\x18\x03 \x03(\v2\x0e.ui.FieldPatchB\b\xbaH\x05\x92\x01\x02\x10\bR\apatches\x127\n" +
	"\vndc_y_sense\x18\x04 \x01(\x0e2\r.ui.NdcYSenseB\b\xbaH\x05\x82\x01\x02\x10\x01R\tndcYSense\"\x9a\x01\n" +
	"\vGestureSpec\x12-\n" +
	...
	"\x12PATCH_OP_MOVE_NODE\x10\x04*\xc9\x03\n" +
	"\n" +
	"WidgetType\x12\x0e\n" +
	"\n" +
	...
	"\fWIDGET_CHART\x10\x14\x12\x15\n" +
	"\x11WIDGET_HOST_PROXY\x10\x15\x12\x19\n" +
	"\x15WIDGET_TARGET_OVERLAY\x10\x16*p\n" +
	"\tProxyMode\x12\x15\n" +
	...
	"\x17PATCH_ENCODING_FLOAT_LE\x10\x03*R\n" +
	"\tNdcYSense\x12\x1b\n" +
	"\x17NDC_Y_SENSE_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eNDC_Y_SENSE_UP\x10\x01\x12\x14\n" +
	"\x10NDC_Y_SENSE_DOWN\x10\x02*\xb6\x01\n" +
...
var file_ui_ui_ast_proto_enumTypes = make([]protoimpl.EnumInfo, 30)
...
var file_ui_ui_ast_proto_goTypes = []any{
	...
	(WidgetType)(0),            // 2: ui.WidgetType
	(ProxyMode)(0),             // 3: ui.ProxyMode
	(EventTrigger)(0),          // 4: ui.EventTrigger
	(PatchKind)(0),             // 5: ui.PatchKind
	(PatchEncoding)(0),         // 6: ui.PatchEncoding
	(NdcYSense)(0),             // 7: ui.NdcYSense
	(GestureKind)(0),           // 8: ui.GestureKind
	(GestureDeltaSign)(0),      // 9: ui.GestureDeltaSign
	(CompareOp)(0),             // 10: ui.CompareOp
	(FlexFlow)(0),              // 11: ui.FlexFlow
	(FlexAlign)(0),             // 12: ui.FlexAlign
	(GridAlign)(0),             // 13: ui.GridAlign
	(TextAlign)(0),             // 14: ui.TextAlign
	(TextDecor)(0),             // 15: ui.TextDecor
	(BlendMode)(0),             // 16: ui.BlendMode
	(BaseDir)(0),               // 17: ui.BaseDir
	(GradDir)(0),               // 18: ui.GradDir
	(Dir)(0),                   // 19: ui.Dir
	(Align)(0),                 // 20: ui.Align
	(BorderSide)(0),            // 21: ui.BorderSide
	(LabelLongMode)(0),         // 22: ui.LabelLongMode
	(BarMode)(0),               // 23: ui.BarMode
	(ArcMode)(0),               // 24: ui.ArcMode
	(RollerMode)(0),            // 25: ui.RollerMode
	(ScaleMode)(0),             // 26: ui.ScaleMode
	(ChartType)(0),             // 27: ui.ChartType
	(ChartAxis)(0),             // 28: ui.ChartAxis
	(StylePropertyType)(0),     // 29: ui.StylePropertyType
	(*SubjectDeclaration)(nil), // 30: ui.SubjectDeclaration
	(*StateUpdate)(nil),        // 31: ui.StateUpdate
	(*SubjectValue)(nil),       // 32: ui.SubjectValue
	(*Screen)(nil),             // 33: ui.Screen
	(*WidgetNode)(nil),         // 34: ui.WidgetNode
	(*TreePatchOp)(nil),        // 35: ui.TreePatchOp
	(*ScreenPatch)(nil),        // 36: ui.ScreenPatch
	(*ObjProps)(nil),           // 37: ui.ObjProps
	(*ButtonProps)(nil),        // 38: ui.ButtonProps
	(*LabelProps)(nil),         // 39: ui.LabelProps
	(*SliderProps)(nil),        // 40: ui.SliderProps
	(*ImageProps)(nil),         // 41: ui.ImageProps
	(*ArcProps)(nil),           // 42: ui.ArcProps
	(*BarProps)(nil),           // 43: ui.BarProps
	(*SwitchProps)(nil),        // 44: ui.SwitchProps
	(*CheckboxProps)(nil),      // 45: ui.CheckboxProps
	(*DropdownProps)(nil),      // 46: ui.DropdownProps
	(*RollerProps)(nil),        // 47: ui.RollerProps
	(*TextareaProps)(nil),      // 48: ui.TextareaProps
	(*SpinboxProps)(nil),       // 49: ui.SpinboxProps
	(*SpinnerProps)(nil),       // 50: ui.SpinnerProps
	(*LedProps)(nil),           // 51: ui.LedProps
	(*LineProps)(nil),          // 52: ui.LineProps
	(*ScaleProps)(nil),         // 53: ui.ScaleProps
	(*ScaleSection)(nil),       // 54: ui.ScaleSection
	(*ButtonMatrixProps)(nil),  // 55: ui.ButtonMatrixProps
	(*TableProps)(nil),         // 56: ui.TableProps
	(*TabviewProps)(nil),       // 57: ui.TabviewProps
	(*ChartSeries)(nil),        // 58: ui.ChartSeries
	(*ChartProps)(nil),         // 59: ui.ChartProps
	(*HostProxyProps)(nil),     // 60: ui.HostProxyProps
	(*TargetBox)(nil),          // 61: ui.TargetBox
	(*TargetOverlayProps)(nil), // 62: ui.TargetOverlayProps
	(*Point)(nil),              // 63: ui.Point
	(*EventBinding)(nil),       // 64: ui.EventBinding
	(*FieldPatch)(nil),         // 65: ui.FieldPatch
	(*CmdSpec)(nil),            // 66: ui.CmdSpec
	(*GestureSpec)(nil),        // 67: ui.GestureSpec
	(*VisibilityBinding)(nil),  // 68: ui.VisibilityBinding
	(*ColorBinding)(nil),       // 69: ui.ColorBinding
	(*Layout)(nil),             // 70: ui.Layout
	(*StyleGroup)(nil),         // 71: ui.StyleGroup
	(*StyleVariant)(nil),       // 72: ui.StyleVariant
	(*StyleProperty)(nil),      // 73: ui.StyleProperty
	(*Color)(nil),              // 74: ui.Color
	(*ShadowBundle)(nil),       // 75: ui.ShadowBundle
	nil,                        // 76: ui.WidgetNode.BindingsEntry
	nil,                        // 77: ui.WidgetNode.BindFormatsEntry
}
var file_ui_ui_ast_proto_depIdxs = []int32{
	0,  // 0: ui.SubjectDeclaration.type:type_name -> ui.SubjectType
	32, // 1: ui.StateUpdate.values:type_name -> ui.SubjectValue
	34, // 2: ui.Screen.root:type_name -> ui.WidgetNode
	30, // 3: ui.Screen.subjects:type_name -> ui.SubjectDeclaration
	2,  // 4: ui.WidgetNode.type:type_name -> ui.WidgetType
	76, // 5: ui.WidgetNode.bindings:type_name -> ui.WidgetNode.BindingsEntry
	64, // 6: ui.WidgetNode.event:type_name -> ui.EventBinding
	70, // 7: ui.WidgetNode.layout:type_name -> ui.Layout
	34, // 8: ui.WidgetNode.children:type_name -> ui.WidgetNode
	71, // 9: ui.WidgetNode.style_groups:type_name -> ui.StyleGroup
	37, // 10: ui.WidgetNode.obj_props:type_name -> ui.ObjProps
	38, // 11: ui.WidgetNode.button_props:type_name -> ui.ButtonProps
	39, // 12: ui.WidgetNode.label_props:type_name -> ui.LabelProps
	40, // 13: ui.WidgetNode.slider_props:type_name -> ui.SliderProps
	41, // 14: ui.WidgetNode.image_props:type_name -> ui.ImageProps
	42, // 15: ui.WidgetNode.arc_props:type_name -> ui.ArcProps
	43, // 16: ui.WidgetNode.bar_props:type_name -> ui.BarProps
	44, // 17: ui.WidgetNode.switch_props:type_name -> ui.SwitchProps
	45, // 18: ui.WidgetNode.checkbox_props:type_name -> ui.CheckboxProps
	46, // 19: ui.WidgetNode.dropdown_props:type_name -> ui.DropdownProps
	47, // 20: ui.WidgetNode.roller_props:type_name -> ui.RollerProps
	48, // 21: ui.WidgetNode.textarea_props:type_name -> ui.TextareaProps
	49, // 22: ui.WidgetNode.spinbox_props:type_name -> ui.SpinboxProps
	50, // 23: ui.WidgetNode.spinner_props:type_name -> ui.SpinnerProps
	51, // 24: ui.WidgetNode.led_props:type_name -> ui.LedProps
	52, // 25: ui.WidgetNode.line_props:type_name -> ui.LineProps
	53, // 26: ui.WidgetNode.scale_props:type_name -> ui.ScaleProps
	55, // 27: ui.WidgetNode.buttonmatrix_props:type_name -> ui.ButtonMatrixProps
	56, // 28: ui.WidgetNode.table_props:type_name -> ui.TableProps
	57, // 29: ui.WidgetNode.tabview_props:type_name -> ui.TabviewProps
	59, // 30: ui.WidgetNode.chart_props:type_name -> ui.ChartProps
	60, // 31: ui.WidgetNode.host_proxy_props:type_name -> ui.HostProxyProps
	62, // 32: ui.WidgetNode.target_overlay_props:type_name -> ui.TargetOverlayProps
	68, // 33: ui.WidgetNode.visibility:type_name -> ui.VisibilityBinding
