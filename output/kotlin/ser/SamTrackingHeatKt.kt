...
@kotlin.jvm.JvmName("-initializesamTrackingHeat")
public inline fun samTrackingHeat(block: ser.SamTrackingHeatKt.Dsl.() -> kotlin.Unit): ser.SamTrackingHeatOuterClass.SamTrackingHeat =
  ser.SamTrackingHeatKt.Dsl._create(ser.SamTrackingHeatOuterClass.SamTrackingHeat.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `ser.SamTrackingHeat`
 */
public object SamTrackingHeatKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: ser.SamTrackingHeatOuterClass.SamTrackingHeat.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: ser.SamTrackingHeatOuterClass.SamTrackingHeat.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): ser.SamTrackingHeatOuterClass.SamTrackingHeat = _builder.build()
    ...
    public val SamTrackingHeatKt.Dsl.frameOrNull: ser.SamTrackingCommon.SamTrackingFrameMeta?
    ...
    public val SamTrackingHeatKt.Dsl.kalmanOrNull: ser.SamTrackingCommon.SamTrackingKalmanState?
...
@kotlin.jvm.JvmSynthetic
public inline fun ser.SamTrackingHeatOuterClass.SamTrackingHeat.copy(block: `ser`.SamTrackingHeatKt.Dsl.() -> kotlin.Unit): ser.SamTrackingHeatOuterClass.SamTrackingHeat =
  `ser`.SamTrackingHeatKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val ser.SamTrackingHeatOuterClass.SamTrackingHeatOrBuilder.frameOrNull: ser.SamTrackingCommon.SamTrackingFrameMeta?
  get() = if (hasFrame()) getFrame() else null

public val ser.SamTrackingHeatOuterClass.SamTrackingHeatOrBuilder.kalmanOrNull: ser.SamTrackingCommon.SamTrackingKalmanState?
