...
static ::_pb::Metadata file_level_metadata_jon_5fshared_5fdata_5fcamera_5fday_2eproto[1];
...
const ::uint32_t TableStruct_jon_5fshared_5fdata_5fcamera_5fday_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_jon_5fshared_5fdata_5fcamera_5fday_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_jon_5fshared_5fdata_5fcamera_5fday_2eproto = {
    false,
    false,
    447,
    ...
    file_level_metadata_jon_5fshared_5fdata_5fcamera_5fday_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_jon_5fshared_5fdata_5fcamera_5fday_2eproto_getter() {
  return &descriptor_table_jon_5fshared_5fdata_5fcamera_5fday_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_jon_5fshared_5fdata_5fcamera_5fday_2eproto(&descriptor_table_jon_5fshared_5fdata_5fcamera_5fday_2eproto);
namespace ser {
// ===================================================================
...
inline void JonGuiDataCameraDay::SharedDtor() {
...
const char* JonGuiDataCameraDay::_InternalParse(
...
::uint8_t* JonGuiDataCameraDay::_InternalSerialize(
  ...
  float tmp_focus_pos = this->_internal_focus_pos();
  ::uint32_t raw_focus_pos;
  memcpy(&raw_focus_pos, &tmp_focus_pos, sizeof(tmp_focus_pos));
  if (raw_focus_pos != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(
        1, this->_internal_focus_pos(), target);
  }
  ...
  if (raw_zoom_pos != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(
        2, this->_internal_zoom_pos(), target);
  }

  // float iris_pos = 3;
  static_assert(sizeof(::uint32_t) == sizeof(float),
                "Code assumes ::uint32_t and float are the same size.");
  float tmp_iris_pos = this->_internal_iris_pos();
  ::uint32_t raw_iris_pos;
  memcpy(&raw_iris_pos, &tmp_iris_pos, sizeof(tmp_iris_pos));
  if (raw_iris_pos != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(
        3, this->_internal_iris_pos(), target);
  }

  // bool infrared_filter = 4;
  if (this->_internal_infrared_filter() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        4, this->_internal_infrared_filter(), target);
  }
  ...
  if (this->_internal_fx_mode() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
        7, this->_internal_fx_mode(), target);
  }
  ...
  if (this->_internal_auto_focus() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        8, this->_internal_auto_focus(), target);
  }

  // bool auto_iris = 9;
  if (this->_internal_auto_iris() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        9, this->_internal_auto_iris(), target);
  }
...
const ::google::protobuf::Message::ClassData JonGuiDataCameraDay::_class_data_ = {
    JonGuiDataCameraDay::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* JonGuiDataCameraDay::GetClassData() const {
  return &_class_data_;
}

void JonGuiDataCameraDay::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  static_assert(sizeof(::uint32_t) == sizeof(float),
                "Code assumes ::uint32_t and float are the same size.");
  float tmp_focus_pos = from._internal_focus_pos();
  ::uint32_t raw_focus_pos;
  memcpy(&raw_focus_pos, &tmp_focus_pos, sizeof(tmp_focus_pos));
  if (raw_focus_pos != 0) {
    _this->_internal_set_focus_pos(from._internal_focus_pos());
  }
  static_assert(sizeof(::uint32_t) == sizeof(float),
                "Code assumes ::uint32_t and float are the same size.");
  ...
  static_assert(sizeof(::uint32_t) == sizeof(float),
                "Code assumes ::uint32_t and float are the same size.");
  float tmp_iris_pos = from._internal_iris_pos();
  ::uint32_t raw_iris_pos;
  memcpy(&raw_iris_pos, &tmp_iris_pos, sizeof(tmp_iris_pos));
  if (raw_iris_pos != 0) {
    _this->_internal_set_iris_pos(from._internal_iris_pos());
  }
  ...
  if (from._internal_infrared_filter() != 0) {
    _this->_internal_set_infrared_filter(from._internal_infrared_filter());
  }
  if (from._internal_auto_focus() != 0) {
    _this->_internal_set_auto_focus(from._internal_auto_focus());
  }
  if (from._internal_auto_iris() != 0) {
    _this->_internal_set_auto_iris(from._internal_auto_iris());
  }
  static_assert(sizeof(::uint32_t) == sizeof(float),
                "Code assumes ::uint32_t and float are the same size.");
...
PROTOBUF_NOINLINE bool JonGuiDataCameraDay::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* JonGuiDataCameraDay::AccessCachedSize() const {
...
::google::protobuf::Metadata JonGuiDataCameraDay::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_jon_5fshared_5fdata_5fcamera_5fday_2eproto_getter, &descriptor_table_jon_5fshared_5fdata_5fcamera_5fday_2eproto_once,
      file_level_metadata_jon_5fshared_5fdata_5fcamera_5fday_2eproto[0]);
}
