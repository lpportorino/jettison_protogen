...
import jon_shared_cmd_power_pb2 as _jon_shared_cmd_power_pb2
import jon_shared_cmd_pmu_pb2 as _jon_shared_cmd_pmu_pb2
import jon_shared_cmd_heater_pb2 as _jon_shared_cmd_heater_pb2
...
class Root(_message.Message):
    __slots__ = ("protocol_version", "session_id", "important", "from_cv_subsystem", "client_type", "client_app", "frame_time_day", "frame_time_heat", "state_time", "client_time_ms", "opaque_payloads", "day_camera", "heat_camera", "gps", "compass", "lrf", "lrf_calib", "rotary", "osd", "ping", "noop", "frozen", "system", "cv", "day_cam_glass_heater", "lira", "power", "pmu", "heater")
    ...
    FRAME_TIME_DAY_FIELD_NUMBER: _ClassVar[int]
    FRAME_TIME_HEAT_FIELD_NUMBER: _ClassVar[int]
    ...
    client_app: _jon_shared_data_types_pb2.JonGuiDataClientApp
    frame_time_day: int
    frame_time_heat: int
    state_time: int
    client_time_ms: int
    ...
    power: _jon_shared_cmd_power_pb2.Root
    pmu: _jon_shared_cmd_pmu_pb2.Root
    heater: _jon_shared_cmd_heater_pb2.Root
    def __init__(self, protocol_version: _Optional[int] = ..., session_id: _Optional[int] = ..., important: bool = ..., from_cv_subsystem: bool = ..., client_type: _Optional[_Union[_jon_shared_data_types_pb2.JonGuiDataClientType, str]] = ..., client_app: _Optional[_Union[_jon_shared_data_types_pb2.JonGuiDataClientApp, str]] = ..., frame_time_day: _Optional[int] = ..., frame_time_heat: _Optional[int] = ..., state_time: _Optional[int] = ..., client_time_ms: _Optional[int] = ..., opaque_payloads: _Optional[_Iterable[_Union[_jon_shared_data_types_pb2.JonOpaquePayload, _Mapping]]] = ..., day_camera: _Optional[_Union[_jon_shared_cmd_day_camera_pb2.Root, _Mapping]] = ..., heat_camera: _Optional[_Union[_jon_shared_cmd_heat_camera_pb2.Root, _Mapping]] = ..., gps: _Optional[_Union[_jon_shared_cmd_gps_pb2.Root, _Mapping]] = ..., compass: _Optional[_Union[_jon_shared_cmd_compass_pb2.Root, _Mapping]] = ..., lrf: _Optional[_Union[_jon_shared_cmd_lrf_pb2.Root, _Mapping]] = ..., lrf_calib: _Optional[_Union[_jon_shared_cmd_lrf_align_pb2.Root, _Mapping]] = ..., rotary: _Optional[_Union[_jon_shared_cmd_rotary_pb2.Root, _Mapping]] = ..., osd: _Optional[_Union[_jon_shared_cmd_osd_pb2.Root, _Mapping]] = ..., ping: _Optional[_Union[Ping, _Mapping]] = ..., noop: _Optional[_Union[Noop, _Mapping]] = ..., frozen: _Optional[_Union[Frozen, _Mapping]] = ..., system: _Optional[_Union[_jon_shared_cmd_system_pb2.Root, _Mapping]] = ..., cv: _Optional[_Union[_jon_shared_cmd_cv_pb2.Root, _Mapping]] = ..., day_cam_glass_heater: _Optional[_Union[_jon_shared_cmd_day_cam_glass_heater_pb2.Root, _Mapping]] = ..., lira: _Optional[_Union[_jon_shared_cmd_lira_pb2.Root, _Mapping]] = ..., power: _Optional[_Union[_jon_shared_cmd_power_pb2.Root, _Mapping]] = ..., pmu: _Optional[_Union[_jon_shared_cmd_pmu_pb2.Root, _Mapping]] = ..., heater: _Optional[_Union[_jon_shared_cmd_heater_pb2.Root, _Mapping]] = ...) -> None: ...
